...
int LabeledImageColorMapping::Describe(ApplicationDescriptor* descriptor)
{
  ...
  descriptor->AddOption("ColorTable", "An ascii file containing the color table with one color per line (for instance line 1 255 0 0 means that all pixel with label 1 will be replaced by RGB  color 255 0 0). Lines begining with a # are ignored.",
