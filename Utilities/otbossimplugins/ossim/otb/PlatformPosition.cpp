...
bool PlatformPosition::saveState(ossimKeywordlist& /*kwl*/, const char* /*prefix*/) const
{
   bool result = true;
...
bool PlatformPosition::loadState(const ossimKeywordlist& /*kwl*/, const char* /*prefix*/)
{
   bool result = true;
