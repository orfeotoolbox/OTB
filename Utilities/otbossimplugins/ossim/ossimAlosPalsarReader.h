...
//----------------------------------------------------------------------------
// $Id$
#ifndef ossimAlosPalsarReader_HEADER
#define ossimAlosPalsarReader_HEADER 1
...
class ossimAlosPalsarReader : public ossimTiffTileSource
{
public:

   /** default constructor */
   ossimAlosPalsarReader();

   /** virtual destructor */
   virtual ~ossimAlosPalsarReader();

   /** @return "alospalsar" */
   virtual ossimString getShortName() const;

   /** @return "ossim ALOS PALSAR reader" */
   virtual ossimString getLongName()  const;

   /** @return "ossimAlosPalsarReader" */
...
#endif /* #ifndef ossimAlosPalsarReader_HEADER */
