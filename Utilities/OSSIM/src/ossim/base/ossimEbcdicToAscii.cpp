...
//
// $Id: ossimEbcdicToAscii.cpp 9094 2006-06-13 19:12:40Z dburken $
//----------------------------------------------------------------------------
#include <ossim/base/ossimEbcdicToAscii.h>

static const ossim_uint8 a2e[] =
{
...
void ossimEbcdicToAscii::ebcdicToAscii(char* str, ossim_uint32 size) const
{
   if (!str) return;
   ...
   {
      str[i] =
         static_cast<char>(ebcdicToAscii(static_cast<ossim_uint8>(str[i])));
   }
}
