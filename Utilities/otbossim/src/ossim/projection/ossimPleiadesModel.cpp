   ...
   :ossimSensorModel(rhs)
{
   ...
   {
      theSupportData = (ossimPleiadesDimapSupportData*)rhs.theSupportData->dup();
   }
   loadSupportData();
   updateModel();
}
...
void ossimPleiadesModel::computeSatToOrbRotation(NEWMAT::Matrix& result, ossim_float64 t)const
{
   if (traceExec())
   {
      ossimNotify(ossimNotifyLevel_DEBUG)
      << "DEBUG ossimPleiadesModel::computeSatToOrbRotation(): entering..."
      << std::endl;
   }
   //---
   ...
   if (traceExec())  ossimNotify(ossimNotifyLevel_DEBUG) << "DEBUG ossimPleiadesModel::computeSatToOrbRotation(): returning..." << std::endl;
}
...
//  METHOD
//*****************************************************************************
void ossimPleiadesModel::computeSatToOrbRotation(ossim_float64 t)const
{
   if (traceExec())
   {
      ossimNotify(ossimNotifyLevel_DEBUG)
...
#endif
//*****************************************************************************
// PUBLIC METHOD: ossimPleiadesModel::updateModel()
//
//  Updates the model parameters given the normalized adjustable parameter
//  array.
//
//*****************************************************************************
void ossimPleiadesModel::updateModel()
{
   clearErrorStatus();

   try
   {
      if (traceExec())  ossimNotify(ossimNotifyLevel_DEBUG) << "DEBUG ossimPleiadesModel::updateModel(): entering..." << std::endl;
      ...
      if (traceExec())  ossimNotify(ossimNotifyLevel_DEBUG) << "DEBUG ossimPleiadesModel::updateModel(): returning..." << std::endl;
   }
   catch(...)
   {
...
void ossimPleiadesModel::initAdjustableParameters()
{
   if (traceExec())  ossimNotify(ossimNotifyLevel_DEBUG) << "DEBUG ossimPleiadesModel::initAdjustableParameters(): entering..." << std::endl;
   ...
   if (traceExec())  ossimNotify(ossimNotifyLevel_DEBUG) << "DEBUG ossimPleiadesModel::initAdjustableParameters(): returning..." << std::endl;
}

void ossimPleiadesModel::loadSupportData()
{
   if (traceExec())  ossimNotify(ossimNotifyLevel_DEBUG) << "ossimPleiadesModel::loadSupportData(): entering..." << std::endl;
   ...
   {
      setErrorStatus();
      ossimNotify(ossimNotifyLevel_FATAL) << "FATAL ossimPleiadesModel::loadSupportData(): Null SpotDimapSupportData pointer passed to"
                                          << " constructor! Aborting..." << std::endl;
      if (traceExec())  ossimNotify(ossimNotifyLevel_DEBUG) << "DEBUG ossimPleiadesModel::loadSupportData(): returning..." << std::endl;
      return;
   }
   ...
   {
      setErrorStatus();
      ossimNotify(ossimNotifyLevel_FATAL) << "FATAL ossimPleiadesModel::loadSupportData(): Bad SpotDimapSupportData detected. Aborting..."
                                          << std::endl;
      if (traceExec()) ossimNotify(ossimNotifyLevel_DEBUG) << "DEBUG ossimPleiadesModel::loadSupportData(): returning..." << std::endl;
      return;
   }
...
void ossimPleiadesModel::imagingRay(const ossimDpt& image_point,
...
void ossimPleiadesModel::lineSampleHeightToWorld(const ossimDpt& image_point,
...
//   if (!insideImage(image_point))
   if ( !theImageClipRect.pointWithin(image_point, 1.0-FLT_EPSILON) )
   {
      ...
      if (traceExec())  ossimNotify(ossimNotifyLevel_DEBUG) << "DEBUG ossimPleiadesModel::lineSampleHeightToWorld(): returning..." << std::endl;
      return;
   }
   //***
...
// ossimDpt ossimPleiadesModel::extrapolate (const ossimGpt& gp) const
// {
//     ossimDpt temp;
...
// ossimGpt ossimPleiadesModel::extrapolate (const ossimDpt& ip,
...
bool
ossimPleiadesModel::setupOptimizer(const ossimString& init_file)
{
   ...
   if(spot5Test.exists())
   {
      ossimRefPtr<ossimPleiadesDimapSupportData> meta = new ossimPleiadesDimapSupportData;
...
bool
ossimPleiadesModel::initFromMetadata(ossimPleiadesDimapSupportData* sd)
{
   // init parms
   theSupportData        = sd;
   theMetaDataFile       = "NOT ASSIGNED";
...
//   theOrbToEcfRotation   = 0.0; //matrix
   ...
   if (getErrorStatus() != ossimErrorCodes::OSSIM_OK)
   {
      if (traceExec())  ossimNotify(ossimNotifyLevel_DEBUG) << "DEBUG ossimPleiadesModel::initFromMetadata(dimap_file): returning with error..." << std::endl;
      return false;
   }
