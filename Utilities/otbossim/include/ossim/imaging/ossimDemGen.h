...
#ifndef ossimDemGen_HEADER
#define ossimDemGen_HEADER 1
 ...
 */
class OSSIM_DLL ossimDemGen : public ossimReferenced
{
public:
...
#endif /* #ifndef ossimDemGen_HEADER */
