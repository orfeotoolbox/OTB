...
_wrap_GetProjectionMethodParamInfo(int argc, VALUE *argv, VALUE self) {
    ...
    SWIG_ConvertPtr(argv[4], (void **) &arg5, SWIGTYPE_p_double, 0);
...
static VALUE
_wrap_SpatialReference_set_towgs84(int argc, VALUE *argv, VALUE self) {
    OSRSpatialReferenceShadow *arg1 = (OSRSpatialReferenceShadow *) 0 ;
    double arg2 ;
    double arg3 ;
    double arg4 ;
...
static VALUE
_wrap_SpatialReference_get_towgs84(int argc, VALUE *argv, VALUE self) {
    OSRSpatialReferenceShadow *arg1 = (OSRSpatialReferenceShadow *) 0 ;
    double *arg2 ;
    OGRErr result;
    double argout2[7] ;
...
_wrap_new_CoordinateTransformation(int argc, VALUE *argv, VALUE self) {
    ...
    if ((argc < 2) || (argc > 2))
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 2)",argc);
    SWIG_ConvertPtr(argv[0], (void **) &arg1, SWIGTYPE_p_OSRSpatialReferenceShadow, 0);
...
_wrap_CoordinateTransformation_transform_point__SWIG_0(int argc, VALUE *argv, VALUE self) {
    ...
    if ((argc < 1) || (argc > 1))
    rb_raise(rb_eArgError, "wrong # of arguments(%d for 1)",argc);
    SWIG_ConvertPtr(self, (void **) &arg1, SWIGTYPE_p_OSRCoordinateTransformationShadow, 0);
    {
...
static VALUE _wrap_CoordinateTransformation_transform_point(int nargs, VALUE *args, VALUE self) {
    int argc;
    VALUE argv[5];
    int ii;
...
SWIGEXPORT void Init_osr(void) {
    ...
    rb_define_method(cSpatialReference.klass, "set_towgs84", VALUEFUNC(_wrap_SpatialReference_set_towgs84), -1);
    rb_define_method(cSpatialReference.klass, "get_towgs84", VALUEFUNC(_wrap_SpatialReference_get_towgs84), -1);
