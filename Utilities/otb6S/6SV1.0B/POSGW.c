...
/*<    >*/
/* Subroutine */ int posgw_(integer *month, integer *jday, real *tu, integer *
...
/*<       ylon=xlon*pi/180.+135.*cdr >*/
    ylon = *xlon * pi / (float)180. + cdr * (float)135.;
/*<       ylat=xlat*pi/180. >*/
