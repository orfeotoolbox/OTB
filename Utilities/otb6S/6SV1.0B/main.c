...
9,\002*\002)";
    ...
    extern /* Subroutine */ int tropic_(), midsum_(), midwin_(), subsum_(), 
	    subwin_(), aeroso_(integer *, real *, real *, real *, char *, 
	    integer *, ftnlen), meteo_(), avhrr_(integer *), modis_(integer *)
	    , polder_(integer *), seawifs_(integer *), aatsr_(integer *), 
	    meris_(integer *), equivwl_(integer *, integer *, real *, real *),
	    ...
	    real *, real *), oceaalbe_(real *, real *, real *, real *, real *,
	     real *), akbrdf_(real *, real *, real *, real *, real *, real *, 
	    real *, real *, real *, real *, integer *, integer *, real *, 
	    real *, real *), akalbe_(real *), oceabrdf_(real *, real *, real *
	    , real *, real *, real *, real *, real *, integer *, integer *, 
	    real *, real *, real *), iapialbe_(integer *, real *, real *, 
	    real *, real *, integer *, real *, real *), hapkalbe_(real *, 
	    real *, real *, real *, real *), vegeta_(real *), clearw_(real *),
	     lakew_(real *), rahmalbe_(real *, real *, real *, real *), 
	    polnad_(real *, real *, real *, real *, real *, real *), polglit_(
	    real *, real *, real *, real *, real *, real *, real *), solirr_(
	    real *, real *), abstra_(integer *, real *, real *, real *, real *
	    , real *, real *, real *, integer *, real *, real *, real *, real 
	    *, real *, real *, real *, real *, real *, real *, real *, real *,
	     real *, real *, real *, real *, real *, real *, real *, real *, 
	    real *, real *, real *, real *, real *), iapibrdf_(integer *, 
	    real *, real *, real *, real *, integer *, real *, integer *, 
	    integer *, real *, real *, real *), hapkbrdf_(real *, real *, 
	    ...
	    , integer *);
    real refet_fi__[181];
    extern /* Subroutine */ int brdfgrid_(integer *, integer *, real *, real *
	    , real *, real *, real *, real *), minnalbe_(real *, real *, real 
	    *), rahmbrdf_(real *, real *, real *, integer *, integer *, real *
	    , real *, real *), enviro_(real *, real *, real *, real *, real *,
	     real *, real *, real *);
    real rqatm2, brdfdats[130]	/* was [10][13] */, ruatm2;
    extern /* Subroutine */ int waltalbe_(real *, real *, real *, real *, 
	    real *);
    real brdfdatv[130]	/* was [10][13] */, tdirqu, rqmeas2;
    extern /* Subroutine */ int minnbrdf_(real *, real *, integer *, integer *
	    , real *, real *);
    real roatm_fi__[10860]	/* was [3][20][181] */, height_z__[101], 
	    phi_wind__, rfoamave;
    extern /* Subroutine */ int versalbe_(integer *, real *, real *, real *), 
	    roujalbe_(real *, real *, real *, real *), waltbrdf_(real *, real 
	    *, real *, real *, integer *, integer *, real *, real *, real *);
    real rumeas2, qlumeas, ulumeas, brdfints[2499]	/* was [51][49] */, 
	    romix_fi__[181], rglitave, brdfintv[2499]	/* was [51][49] */;
    extern /* Subroutine */ int versbrdf_(integer *, real *, real *, integer *
	    , integer *, real *, real *, real *), roujbrdf_(real *, real *, 
	    real *, integer *, integer *, real *, real *, real *);
    real sbrdftmp[3]	/* was [3][1] */, qlumet, ulumet, rqfet, rufet, xtphi;
    ...
    extern /* Subroutine */ int modisalbe_(real *, real *, real *, real *);
    integer iaer_prof__;
    extern /* Subroutine */ int modisbrdf_(real *, real *, real *, integer *, 
	    integer *, real *, real *, real *);
    integer i1, i2;
    real p1, p2, p3, rorayl_fi__[181];
    ...
    real ul, ea0, ee0, elsesdpaer, pi2;
    integer mu2;
    real uo3;
    extern /* Subroutine */ int specinterp_(real *, real *, real *, real *, 
	    real *, real *, real *, integer *);
    real robarpstar, fae, cfi, eei, hna, ani[6]	/* was [2][3] */, rad, seb, 
	    fra, sha, tdd, pcl, anr[6]	/* was [2][3] */, phi, rob, roc, roe, 
	    rog, avr, dtr, etn, esn, xle, tdu, its, srm[3], srp[1], swl, xpp, 
	    xlt, xps, puw, tsd, tsu, azw, pps, prl, ptl, prs, ea0n, pws, paw, 
	    uli, ee0n, sli, cwi;
    integer nfi;
    extern /* Subroutine */ int us62_();
    real phi0;
    extern /* Subroutine */ int hrv_(integer *);
    real par1, par2, par3, par4, xla0;
    ...
    real xlm1[2499]	/* was [51][49] */, xlm2[2499]	/* was [51][49] */, 
	    puo3, cabi, adif, scaa, phaa, qhaa, coef, uhaa, aini[6]	/* 
	    was [2][3] */;
    integer iaer;
    char file[80];
    integer iinf;
    real tdif, sasa, sham, ainr[6]	/* was [2][3] */, phar, taer, tsca, 
	    asol, rocl[1501], roel[1501], avis, dsol, rdir, phiv, rapp, xlat, 
    ...
    real palt;
    integer pild, pihs;
    real pxlt, xla0n, ratm1, ratm2, ratm3, robarbarstar, xsal, rwat, thmi, 
	    vaii, rnci, rsl1i;
    extern /* Subroutine */ int oda550_(integer *, real *, real *);
    real puoz;
    extern /* Subroutine */ int goes_(integer *), sand_(real *);
    real xpol, edifa, cscaa, coefa, uo3us, coefb, coefc;
    integer iread, ibrdf, aerod;
    real campm, dgasm, asaer, sbrdf[1501];
    integer niinf;
    real robar[1501], taer55, refet, tgasm, ugasm, rodir, filut[1025]	/* 
	    was [25][41] */, spalt, rpfet, taerp, tamoy, rdown, astot;
    integer nisup;
    real romix, trayp, dtott, rqmix, rumix, rolut[1025]	/* was [25][41] */, 
	    asray, wlmoy, xlmus[2499]	/* was [51][49] */, utota, xlmuv[2499]
	    	/* was [51][49] */, trmoy, utotr, luttv, utott, dtotr, dtota, 
	    dgtot, puwus, tgtot, robar1, robar2, refet1, refet2, refet3, 
	    coefp, ugtot, edifr, tdird, tdiru, rpfet1, rpfet2, rpfet3, tdifd, 
	    tdifu, rsurf, tmdir, tmdif;
    integer igeom, month, idatm, iaerp, iwave, igrou1, igrou2, isort;
    real xnorm1, xnorm2;
    integer irapp;
    real sddica, dtdica, rwatl[1501], iscama, puo3us;
    integer nbisca, idirec;
    real anglem[48], iscami, phirad, sdmoca, robard[1501], sudica, stdica, 
	    dtmoca, rocave, sodaer, roeave, fophsa, ssdaer, sdmeth, robarp[
	    1501], taer55p, alumet, sdwava, sumoca, stmoca, sroaer, nwlinf, 
	    sdtota, xlonan, dtmeth, xlphim[181];
    integer nfilut[25];
    ...
    real discri, rogbrdf, rfoaml[1501], rglitl[1501], sodrayp, sdppray, 
	    spdpray, cij_out__[4], ftray, optics[3], struct__[4];
    integer options[5];
    real sodtotp, sdpptot, spdptot, rolutiq[1025]	/* was [25][41] */, 
	    rfoam, rglit, ratm2_fi__[181], rolutiu[1025]	/* was [25][
	    41] */, rwatave;
    extern /* Subroutine */ int gauss_(real *, real *, real *, real *, 
	    integer *);
    real pizmoyp;
    extern /* Subroutine */ int posmto_(integer *, integer *, real *, integer 
	    *, integer *, real *, real *, real *, real *, real *, real *);
    real rolutsq[20500]	/* was [20][25][41] */;
    extern /* Subroutine */ int posge_(integer *, integer *, real *, integer *
	    , integer *, real *, real *, real *, real *, real *, real *), 
	    posgw_(integer *, integer *, real *, integer *, integer *, real *,
	     real *, real *, real *, real *, real *), posnoa_(integer *, 
	    integer *, real *, integer *, real *, real *, real *, real *, 
	    real *, real *, real *, real *, real *);
    real rolutsu[20500]	/* was [20][25][41] */;
    extern /* Subroutine */ int posspo_(integer *, integer *, real *, real *, 
	    real *, real *, real *, real *, real *), poslan_(integer *, 
	    integer *, real *, real *, real *, real *, real *, real *, real *)
	    , varsol_(integer *, integer *, real *);
...
L1001:
    ...
    do_lio(&c__3, &c__1, (char *)&month, (ftnlen)sizeof(integer));
    do_lio(&c__3, &c__1, (char *)&jday, (ftnlen)sizeof(integer));
    do_lio(&c__4, &c__1, (char *)&tu, (ftnlen)sizeof(real));
...
L1004:
    ...
    do_lio(&c__4, &c__1, (char *)&tu, (ftnlen)sizeof(real));
    do_lio(&c__3, &c__1, (char *)&nc, (ftnlen)sizeof(integer));
    do_lio(&c__4, &c__1, (char *)&xlonan, (ftnlen)sizeof(real));
    do_lio(&c__4, &c__1, (char *)&hna, (ftnlen)sizeof(real));
    e_rsle();
/*<       campm=1.0 >*/
    campm = (float)1.;
/*<    >*/
...
/*<        read(iread,*) z(k),p(k),t(k),wh(k),wo(k) >*/
	...
	s_rsle(&io___71);
	do_lio(&c__4, &c__1, (char *)&sixs_atm__1.z__[k - 1], (ftnlen)sizeof(
		real));
	do_lio(&c__4, &c__1, (char *)&sixs_atm__1.p[k - 1], (ftnlen)sizeof(
		real));
	do_lio(&c__4, &c__1, (char *)&sixs_atm__1.t[k - 1], (ftnlen)sizeof(
		real));
	do_lio(&c__4, &c__1, (char *)&sixs_atm__1.wh[k - 1], (ftnlen)sizeof(
		real));
	do_lio(&c__4, &c__1, (char *)&sixs_atm__1.wo[k - 1], (ftnlen)sizeof(
		real));
	e_rsle();
/*<     7 continue >*/
/* L7: */
...
/*<       v=exp(-log(taer55/2.7628)/0.79902) >*/
	v = exp(-log(taer55 / (float)2.7628) / (float).79902);
/*<       goto 71 >*/
	goto L71;
...
/* L771: */
    ...
    s_rsle(&io___110);
    do_lio(&c__4, &c__1, (char *)&xps, (ftnlen)sizeof(real));
    e_rsle();
/*<        if (xps.ge.0.) then >*/
    if (xps >= (float)0.) {
/*<         xps=0. >*/
...
/*<         read(iread,*) xpp >*/
    ...
    s_rsle(&io___114);
    do_lio(&c__4, &c__1, (char *)&xpp, (ftnlen)sizeof(real));
    e_rsle();
/*<         xpp=-xpp >*/
    xpp = -xpp;
/*<         if (xpp.le.0.0) then >*/
...
L16:
    ...
    s_rsle(&io___132);
    do_lio(&c__4, &c__1, (char *)&wl, (ftnlen)sizeof(real));
    e_rsle();
/*<       wlinf=wl >*/
...
L17:
    ...
    s_rsle(&io___134);
    do_lio(&c__4, &c__1, (char *)&sixs_ffu__1.wlinf, (ftnlen)sizeof(real));
    do_lio(&c__4, &c__1, (char *)&sixs_ffu__1.wlsup, (ftnlen)sizeof(real));
    e_rsle();
/*<       go to 19 >*/
    goto L19;
...
/*<       read(iread,*) (s(i),i=iinf,isup) >*/
	...
	do_lio(&c__4, &c__1, (char *)&sixs_ffu__1.s[i__ - 1], (ftnlen)sizeof(
		real));
    }
    e_rsle();
/*<       goto 20 >*/
...
/*<         read(iread,*) (brdfdats(10-j+1,k),j=1,10) >*/
	...
	s_rsle(&io___184);
	for (j = 1; j <= 10; ++j) {
	    do_lio(&c__4, &c__1, (char *)&brdfdats[10 - j + 1 + k * 10 - 11], 
		    (ftnlen)sizeof(real));
	}
	e_rsle();
/*<   900 continue >*/
...
/*<         read(iread,*) (brdfdatv(10-j+1,k),j=1,10) >*/
	...
	s_rsle(&io___186);
	for (j = 1; j <= 10; ++j) {
	    do_lio(&c__4, &c__1, (char *)&brdfdatv[10 - j + 1 + k * 10 - 11], 
		    (ftnlen)sizeof(real));
	}
	e_rsle();
/*<   901 continue >*/
...
/*<       read(iread,*) albbrdf >*/
    ...
    s_rsle(&io___188);
    do_lio(&c__4, &c__1, (char *)&albbrdf, (ftnlen)sizeof(real));
    e_rsle();
/*<       read(iread,*) rodir >*/
    io___190.ciunit = iread;
    s_rsle(&io___190);
    do_lio(&c__4, &c__1, (char *)&rodir, (ftnlen)sizeof(real));
    e_rsle();
/*<       rm(-mu)=phirad >*/
    rm[-mu + 25] = phirad;
/*<       rm(mu)=xmuv >*/
...
/*<         read(iread,*) par1,par2,par3,par4 >*/
	...
	s_rsle(&io___195);
	do_lio(&c__4, &c__1, (char *)&par1, (ftnlen)sizeof(real));
	do_lio(&c__4, &c__1, (char *)&par2, (ftnlen)sizeof(real));
	do_lio(&c__4, &c__1, (char *)&par3, (ftnlen)sizeof(real));
	do_lio(&c__4, &c__1, (char *)&par4, (ftnlen)sizeof(real));
	e_rsle();
/*<         srm(-1)=phirad >*/
	srm[0] = phirad;
/*<         srm(1)=xmuv >*/
...
/*<         read(iread,*) (struct(i),i=1,4) >*/
	...
	s_rsle(&io___205);
	for (i__ = 1; i__ <= 4; ++i__) {
	    do_lio(&c__4, &c__1, (char *)&struct__[i__ - 1], (ftnlen)sizeof(
		    real));
	}
	e_rsle();
/*<         read(iread,*) (optics(i),i=1,3) >*/
	...
	s_rsle(&io___207);
	for (i__ = 1; i__ <= 3; ++i__) {
	    do_lio(&c__4, &c__1, (char *)&optics[i__ - 1], (ftnlen)sizeof(
		    real));
	}
	e_rsle();
/*<         srm(-1)=phirad >*/
...
/*<         read(iread,*) pws,phi_wind,xsal,pcl >*/
	...
	s_rsle(&io___212);
	do_lio(&c__4, &c__1, (char *)&pws, (ftnlen)sizeof(real));
	do_lio(&c__4, &c__1, (char *)&phi_wind__, (ftnlen)sizeof(real));
	do_lio(&c__4, &c__1, (char *)&xsal, (ftnlen)sizeof(real));
	do_lio(&c__4, &c__1, (char *)&pcl, (ftnlen)sizeof(real));
	e_rsle();
...
/*<         read(iread,*) pxLt,pc >*/
	...
	s_rsle(&io___227);
	do_lio(&c__4, &c__1, (char *)&pxlt, (ftnlen)sizeof(real));
	do_lio(&c__4, &c__1, (char *)&pc, (ftnlen)sizeof(real));
	e_rsle();
/*<         read(iread,*) pRl,pTl,pRs >*/
	io___230.ciunit = iread;
	s_rsle(&io___230);
	do_lio(&c__4, &c__1, (char *)&prl, (ftnlen)sizeof(real));
	do_lio(&c__4, &c__1, (char *)&ptl, (ftnlen)sizeof(real));
	do_lio(&c__4, &c__1, (char *)&prs, (ftnlen)sizeof(real));
	e_rsle();
/*<         srm(-1)=phirad >*/
	srm[0] = phirad;
/*<         srm(1)=xmuv >*/
...
/*<          read(iread,*) uli,eei,thmi,sli >*/
	...
	s_rsle(&io___235);
	do_lio(&c__4, &c__1, (char *)&uli, (ftnlen)sizeof(real));
	do_lio(&c__4, &c__1, (char *)&eei, (ftnlen)sizeof(real));
	do_lio(&c__4, &c__1, (char *)&thmi, (ftnlen)sizeof(real));
	do_lio(&c__4, &c__1, (char *)&sli, (ftnlen)sizeof(real));
	e_rsle();
/*<          read(iread,*) cabi,cwi,vaii,rnci,rsl1i >*/
	io___240.ciunit = iread;
	s_rsle(&io___240);
	do_lio(&c__4, &c__1, (char *)&cabi, (ftnlen)sizeof(real));
	do_lio(&c__4, &c__1, (char *)&cwi, (ftnlen)sizeof(real));
	do_lio(&c__4, &c__1, (char *)&vaii, (ftnlen)sizeof(real));
	do_lio(&c__4, &c__1, (char *)&rnci, (ftnlen)sizeof(real));
	do_lio(&c__4, &c__1, (char *)&rsl1i, (ftnlen)sizeof(real));
	e_rsle();
/*<         do l=iinf,isup >*/
	i__1 = isup;
	for (l = iinf; l <= i__1; ++l) {
...
/*<          read(iread,*)p1,p2,p3 >*/
	...
	s_rsle(&io___246);
	do_lio(&c__4, &c__1, (char *)&p1, (ftnlen)sizeof(real));
	do_lio(&c__4, &c__1, (char *)&p2, (ftnlen)sizeof(real));
	do_lio(&c__4, &c__1, (char *)&p3, (ftnlen)sizeof(real));
	e_rsle();
/*<            srm(-1)=phirad >*/
	srm[0] = phirad;
/*<            srm(1)=xmuv >*/
...
L29:
    ...
    s_rsle(&io___263);
    do_lio(&c__4, &c__1, (char *)&nwlinf, (ftnlen)sizeof(real));
    do_lio(&c__4, &c__1, (char *)&nwlsup, (ftnlen)sizeof(real));
    e_rsle();
/*<       niinf=(nwlinf-.25)/0.0025+1.5 >*/
    niinf = (nwlinf - (float).25) / (float).0025 + (float)1.5;
/*<       nisup=(nwlsup-.25)/0.0025+1.5 >*/
    nisup = (nwlsup - (float).25) / (float).0025 + (float)1.5;
/*<       read(iread,*) (rocl(i),i=niinf,nisup) >*/
    io___268.ciunit = iread;
    s_rsle(&io___268);
    i__1 = nisup;
    for (i__ = niinf; i__ <= i__1; ++i__) {
	do_lio(&c__4, &c__1, (char *)&rocl[i__ - 1], (ftnlen)sizeof(real));
    }
    e_rsle();
/*<       goto 36 >*/
    goto L36;
...
L32:
    ...
    s_rsle(&io___269);
    do_lio(&c__4, &c__1, (char *)&ro, (ftnlen)sizeof(real));
    e_rsle();
/*<       do 35 l=iinf,isup >*/
    i__1 = isup;
    for (l = iinf; l <= i__1; ++l) {
...
L31:
    ...
    do_lio(&c__4, &c__1, (char *)&rad, (ftnlen)sizeof(real));
    e_rsle();
/*<       if(igrou1) 59,60,63 >*/
    if (igrou1 < 0) {
	goto L59;
...
L60:
    ...
    s_rsle(&io___275);
    do_lio(&c__4, &c__1, (char *)&roc, (ftnlen)sizeof(real));
    e_rsle();
/*<       do 64 l=iinf,isup >*/
    i__1 = isup;
    for (l = iinf; l <= i__1; ++l) {
...
L66:
    ...
    i__1 = isup;
    for (i__ = iinf; i__ <= i__1; ++i__) {
	do_lio(&c__4, &c__1, (char *)&roel[i__ - 1], (ftnlen)sizeof(real));
    }
    e_rsle();
/*<       goto 34 >*/
    goto L34;
...
L62:
    ...
    s_rsle(&io___278);
    do_lio(&c__4, &c__1, (char *)&roe, (ftnlen)sizeof(real));
    e_rsle();
/*<       do 67 l=iinf,isup >*/
    i__1 = isup;
    for (l = iinf; l <= i__1; ++l) {
...
/*<          read(iread,*) rapp >*/
	...
	s_rsle(&io___282);
	do_lio(&c__4, &c__1, (char *)&rapp, (ftnlen)sizeof(real));
	e_rsle();
/*<          endif >*/
    }
/* **********************************************************************c
...
/*<    >*/
	    ...
	    s_wsfe(&io___350);
	    do_fio(&c__1, (char *)&rocave, (ftnlen)sizeof(real));
	    r__1 = robar1 / xnorm1;
	    do_fio(&c__1, (char *)&r__1, (ftnlen)sizeof(real));
	    r__2 = robar2 / xnorm2;
	    do_fio(&c__1, (char *)&r__2, (ftnlen)sizeof(real));
...
/*<          write(iwr,500) rfoamave,rwatave,rglitave >*/
	    ...
	    s_wsfe(&io___370);
	    do_fio(&c__1, (char *)&rfoamave, (ftnlen)sizeof(real));
	    do_fio(&c__1, (char *)&rwatave, (ftnlen)sizeof(real));
	    do_fio(&c__1, (char *)&rglitave, (ftnlen)sizeof(real));
	    e_wsfe();
/*<    >*/
...
L2011:
	    ...
	    do_fio(&c__1, (char *)&p2, (ftnlen)sizeof(real));
	    do_fio(&c__1, (char *)&p3, (ftnlen)sizeof(real));
	    e_wsfe();
/*<    >*/
...
/*<    >*/
	    ...
	    do_fio(&c__1, (char *)&roc, (ftnlen)sizeof(real));
...
/*< 	srpray=sqrt(srqray**2.+sruray**2.) >*/
	...
	srpray = sqrt(pow_dd(&d__1, &c_b887) + pow_dd(&d__2, &c_b887));
/*<  	srpaer=sqrt(srqaer**2.+sruaer**2.) >*/
	d__1 = (doublereal) srqaer;
	d__2 = (doublereal) sruaer;
	srpaer = sqrt(pow_dd(&d__1, &c_b887) + pow_dd(&d__2, &c_b887));
/*< 	srptot=sqrt(srqtot**2.+srutot**2.) >*/
	d__1 = (doublereal) srqtot;
	d__2 = (doublereal) srutot;
	srptot = sqrt(pow_dd(&d__1, &c_b887) + pow_dd(&d__2, &c_b887));
