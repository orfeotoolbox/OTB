...
/* Subroutine */ int oxyg4_(real *a, integer *inu)
{
    /* Initialized data */
    ...
    static real acr[2048]	/* was [8][256] */ = { (float)0.,(float)0.,(
	    ...
	    2.485e-8,(float).039407,(float).053053,(float)-2.1221e-4,(float)
	    .051025,(float)-2.0813e-4,(float)11490.,(float)11500.,(float)
	    1.1624e-7,(float).079933,(float).048686,(float)-1.9403e-4,(float)
	    .046806,(float)-1.9088e-4,(float)11500.,(float)11510.,(float)
	    1.0964e-7,(float).043304,(float).045502,(float)-1.8201e-4,(float)
	    .043474,(float)-1.7792e-4,(float)11510.,(float)11520.,(float)
	    2.5643e-7,(float).066862,(float).042844,(float)-1.7105e-4,(float)
	    .040871,(float)-1.6735e-4,(float)11520.,(float)11530.,(float)
	    3.2105e-7,(float).068728,(float).040797,(float)-1.6299e-4,(float)
	    .038797,(float)-1.5911e-4,(float)11530.,(float)11540.,(float)
	    3.5585e-7,(float).071858,(float).038944,(float)-1.557e-4,(float)
	    .036916,(float)-1.5165e-4,(float)11540.,(float)11550.,(float)
	    2.4915e-7,(float).074592,(float).037957,(float)-1.5179e-4,(float)
	    .035912,(float)-1.4766e-4,(float)11550.,(float)11560.,(float)
	    4.9923e-8,(float).026857,(float).037416,(float)-1.4966e-4,(float)
	    .035388,(float)-1.4558e-4,(float)11560.,(float)11570.,(float)
	    2.5239e-7,(float).096092,(float).037615,(float)-1.5045e-4,(float)
	    .035561,(float)-1.4627e-4,(float)11570.,(float)11580.,(float)
	    5.8358e-7,(float).11778,(float).039104,(float)-1.5615e-4,(float)
	    .03708,(float)-1.5221e-4,(float)11580.,(float)11590.,(float)
	    4.8767e-7,(float).11043,(float).041978,(float)-1.6721e-4,(float)
	    .04006,(float)-1.6392e-4,(float)11590.,(float)11600.,(float)
	    2.0866e-7,(float).10009,(float).046771,(float)-1.859e-4,(float)
	    .045,(float)-1.8335e-4,(float)11600.,(float)11610.,(float)
	    6.2339e-8,(float).091546,(float).052598,(float)-2.0809e-4,(float)
	    .051104,(float)-2.0723e-4,(float)11610.,(float)11620.,(float)0.,(
	    float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)11620.,(
	    float)11630.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)11630.,(float)11640.,(float)0.,(float)0.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)11640.,(float)11650.,(
	    float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    11650.,(float)11660.,(float)0.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)11660.,(float)11670.,(float)0.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)11670.,(float)
	    11680.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    0.,(float)11680.,(float)11690.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)0.,(float)11690.,(float)11700.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    11700.,(float)11710.,(float)0.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)11710.,(float)11720.,(float)0.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)11720.,(float)
	    11730.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    0.,(float)11730.,(float)11740.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)0.,(float)11740.,(float)11750.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    11750.,(float)11760.,(float)0.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)11760.,(float)11770.,(float)0.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)11770.,(float)
	    11780.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    0.,(float)11780.,(float)11790.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)0.,(float)11790.,(float)11800.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    11800.,(float)11810.,(float)0.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)11810.,(float)11820.,(float)0.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)11820.,(float)
	    11830.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    0.,(float)11830.,(float)11840.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)0.,(float)11840.,(float)11850.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    11850.,(float)11860.,(float)0.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)11860.,(float)11870.,(float)0.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)11870.,(float)
	    11880.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    0.,(float)11880.,(float)11890.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)0.,(float)11890.,(float)11900.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    11900.,(float)11910.,(float)0.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)11910.,(float)11920.,(float)0.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)11920.,(float)
	    11930.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    0.,(float)11930.,(float)11940.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)0.,(float)11940.,(float)11950.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    11950.,(float)11960.,(float)0.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)11960.,(float)11970.,(float)0.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)11970.,(float)
	    11980.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    0.,(float)11980.,(float)11990.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)0.,(float)11990.,(float)1.2e4,(float)0.,
	    (float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)1.2e4,(
	    float)12010.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)12010.,(float)12020.,(float)0.,(float)0.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)12020.,(float)12030.,(
	    float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    12030.,(float)12040.,(float)0.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)12040.,(float)12050.,(float)0.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)12050.,(float)
	    12060.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    0.,(float)12060.,(float)12070.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)0.,(float)12070.,(float)12080.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    12080.,(float)12090.,(float)0.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)12090.,(float)12100.,(float)0.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)12100.,(float)
	    12110.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    0.,(float)12110.,(float)12120.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)0.,(float)12120.,(float)12130.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    12130.,(float)12140.,(float)0.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)12140.,(float)12150.,(float)0.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)12150.,(float)
	    12160.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    0.,(float)12160.,(float)12170.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)0.,(float)12170.,(float)12180.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    12180.,(float)12190.,(float)0.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)12190.,(float)12200.,(float)0.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)12200.,(float)
	    12210.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    0.,(float)12210.,(float)12220.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)0.,(float)12220.,(float)12230.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    12230.,(float)12240.,(float)0.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)12240.,(float)12250.,(float)0.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)12250.,(float)
	    12260.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    0.,(float)12260.,(float)12270.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)0.,(float)12270.,(float)12280.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    12280.,(float)12290.,(float)0.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)12290.,(float)12300.,(float)0.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)12300.,(float)
	    12310.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    0.,(float)12310.,(float)12320.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)0.,(float)12320.,(float)12330.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    12330.,(float)12340.,(float)0.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)12340.,(float)12350.,(float)0.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)12350.,(float)
	    12360.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    0.,(float)12360.,(float)12370.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)0.,(float)12370.,(float)12380.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    12380.,(float)12390.,(float)0.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)12390.,(float)12400.,(float)0.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)12400.,(float)
	    12410.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    0.,(float)12410.,(float)12420.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)0.,(float)12420.,(float)12430.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    12430.,(float)12440.,(float)0.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)12440.,(float)12450.,(float)0.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)12450.,(float)
	    12460.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    0.,(float)12460.,(float)12470.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)0.,(float)12470.,(float)12480.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    12480.,(float)12490.,(float)0.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)12490.,(float)12500.,(float)0.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)12500.,(float)
	    12510.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    0.,(float)12510.,(float)12520.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)0.,(float)12520.,(float)12530.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    12530.,(float)12540.,(float)0.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)12540.,(float)12550.,(float)0.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)12550.,(float)
	    12560.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    0.,(float)12560.,(float)12570.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)0.,(float)12570.,(float)12580.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    12580.,(float)12590.,(float)0.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)12590.,(float)12600.,(float)0.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)12600.,(float)
	    12610.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    0.,(float)12610.,(float)12620.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)0.,(float)12620.,(float)12630.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    12630.,(float)12640.,(float)0.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)12640.,(float)12650.,(float)0.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)12650.,(float)
	    12660.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    0.,(float)12660.,(float)12670.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)0.,(float)12670.,(float)12680.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    12680.,(float)12690.,(float)0.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)12690.,(float)12700.,(float)0.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)12700.,(float)
	    12710.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    0.,(float)12710.,(float)12720.,(float)0.,(float)0.,(float)0.,(
	    float)0.,(float)0.,(float)0.,(float)12720.,(float)12730.,(float)
	    0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)0.,(float)
	    12730.,(float)12740. };
