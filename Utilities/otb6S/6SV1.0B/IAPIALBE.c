...
static real c_b54 = (float)-1.;
static real c_b55 = (float)1.;

/*<    >*/
/* Subroutine */ int iapialbe_(integer *pild, real *pxlt, real *prl, real *
	ptl, real *prs, integer *pihs, real *pc, real *brdfalb)
{
    /* Builtin functions */
    ...
    /* Local variables */
    integer j, k, l;
    real y, fa[48], fi, ta[24], si1, si2, mu1, mu2;
    extern /* Subroutine */ int lad_();
    real wfa[48];
    integer ihs;
    real wta[24];
    extern doublereal ro_1__(real *, real *, real *, real *);
    real phi1, phi2, pond, summ, teta1, teta2, phi_i__, phi_v__;
    extern /* Subroutine */ int gauss_(real *, real *, real *, real *, 
	    integer *), solve_(real *), gauleg_(real *, real *, real *, real *
	    , integer *);
