...
/*<    >*/
/* Subroutine */ int posmto_(integer *month, integer *jday, real *tu, integer 
	*nc, integer *nl, real *asol, real *phi0, real *avis, real *phiv, 
	real *xlon, real *xlat)
{
...
/*     meteosat definition */
/*<       yr=float(nl)-1250.5 >*/
    yr = (real) (*nl) - (float)1250.5;
/*<       xr=float(nc)-2500.5 >*/
    xr = (real) (*nc) - (float)2500.5;
/*<       alti=42164.0-6378.155 >*/
    alti = (float)35785.845000000001;
/*<       re=6378.155 >*/
    re = (float)6378.155;
/*<       aaa=1./297. >*/
...
/*<       crd=180./pi >*/
    crd = (float)180. / pi;
/*<       deltax=18.0/5000.0 >*/
    deltax = (float).0035999999999999999;
/*<       deltay=18.0/2500.0 >*/
    deltay = (float).0071999999999999998;
/*<       x=xr*deltax*cdr >*/
    x = xr * deltax * cdr;
/*<       y=yr*deltay*cdr >*/
    y = yr * deltay * cdr;
