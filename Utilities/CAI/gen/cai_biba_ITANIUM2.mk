/*-----------------------------------------------*/
/* Makefile COUCHE ACCES IMAGE pour HP ITANIUM2  */
/* Version : $Header: cai_biba_ITANIUM2.mk$ */
/*--------------------------------------------*/
/* Chemins d'acces */

DIRSRC = $(RACINE_ATLAS)/src
DIRBIB = $(RACINE_ATLAS)/bib/bin_ITANIUM2
...
$(LIBTIFF):
	(cd  $(TIFFDIR) ;make -f Makefile_itanium2 clean;  make -f Makefile_itanium2 CC='$(CC)' )


$(JPEGOBJECTS):
	(cd  $(JPEGDIR) ;make -f makefile_itanium2 clean;  make -f makefile_itanium2 CC='$(CC)' )
