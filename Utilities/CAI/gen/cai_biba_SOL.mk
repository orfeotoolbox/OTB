/*--------------------------------------------*/
/* Makefile COUCHE ACCES IMAGE pour SUN SOLARIS (OS.5) */
/* Version : $Header: cai_biba_SOL.mk,v 1.7 01/01/15 15:24:07 cmf Exp $ */
/*--------------------------------------------*/
/* Chemins d'acces */
...
RM = rm
CC = cc
CCOPTS	= -D_SOLARIS $(CCOPTS64) -xO2
/* CCOPTS	= -g -D_SOLARIS $(CCOPTS64) */


#ifdef _HDF16
DIRHDF=$(RACINE_HDF)
HDFINC =$(RACINE_HDF)/include
FLAGS = -I$(DIRINC) -I$(HDFINC) -I$(DIRXML) -I$(JPEGINC) -D_HDF16
#endif
#ifdef _NOHDF16
DIRHDF=
HDFINC =
...
$(LIBTIFF):
	( cd $(TIFFDIR) ; make -f Makefile.solaris clean ; make -f Makefile.solaris CC='$(CC)' 'CCOPTS=$(CCOPTS)')


$(JPEGOBJECTS):
	(cd  $(JPEGDIR) ;make -f makefile.cai clean;  make -f makefile.cai CC='$(CC)' 'CCOPTS=$(CCOPTS)')
