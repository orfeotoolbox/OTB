...
/* Version : $Header: cai_biba_DEC.mk,v 1.2 01/01/15 15:24:13 cmf Exp $ */
/*----------------------------------------------------------------------*/
/* Chemins d'acces */
...
$(DIRBIB)/cai_spot.o : $(DIRSRC)/cai_spot.c
	@echo "--> Generation du binaire cai_spot.o"
	@$(CC) $(CCOPTS) -c  $(FLAGS) $(DIRSRC)/cai_spot.c -o $@

$(DIRBIB)/cai_bandeau.o : $(DIRSRC)/cai_bandeau.c
...
$(LIBTIFF):
	( cd $(TIFFDIR) ; make -f Makefile.dec clean ; make -f Makefile.dec CC='$(CC)')


$(JPEGOBJECTS):
	(cd  $(JPEGDIR) ;make -f makefile.cai clean;  make -f makefile.cai CC='$(CC)' )
