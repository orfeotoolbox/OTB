...
/* Version : $Header: cai_bibsl_AIX.mk,v 1.3 01/01/15 15:24:13 cmf Exp $ */
/*--------------------------------------------*/
...
DIRHDF = $(RACINE_HDF)
FLAGS = $(SLFLAGS) -I$(HDFINC) -I$(JPEGINC) -I$(DIRINC) -D_HDF16
#endif
#ifdef _NOHDF16
HDFINC = 
DIRHDF = 
FLAGS = $(SLFLAGS) -I$(DIRINC) -D_NOHDF16
#endif
...
${ALL2} : $(DEPBIN) $(DIRINC)/cai_image.h $(JPEGOBJECTS)
	...
	@echo "--> Generation de la bibliotheque partageable"
	ld -b -o $(DIRBIB)/cai_couche_ima.sl  $(FIC_VERS_OBJ) $(DEPBIN) $(JPEGOBJECTS) `find $(DIRBIB)/HDF -type f -name '*.o' -print`
	@$(RM) -rf $(DIRBIB)/HDF
#endif
#ifdef _NOHDF16
	@echo "--> Generation de la bibliotheque partageable"
	ld -b -o $(DIRBIB)/cai_couche_ima.sl  $(FIC_VERS_OBJ) $(DEPBIN) $(JPEGOBJECTS)
#endif
...
$(DIRBIB)/cai_DonAux.o : $(DIRSRC)/cai_DonAux.c  $(DIRINC)/cai_image.h
	@echo "--> Generation du binaire cai_DonAux.o"
	$(CC) $(CCOPTS) -c $(FLAGS) $(DIRSRC)/cai_DonAux.c -o $@

$(LIBTIFF):
	( cd $(TIFFDIR) ; make -f Makefile.aix clean ; make -f Makefile.aix CC='$(CC)';cp libtiff.a $(DIRBIB))


$(JPEGOBJECTS):
	( CC='gcc -g'; cd  $(JPEGDIR) ;make -f makefile.cai clean; make -f makefile.cai CC='$(CC)' SLFLAG='$(SLFLAGS)')
