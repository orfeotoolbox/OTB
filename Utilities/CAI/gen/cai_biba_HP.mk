...
/* Version : $Header: cai_biba_HP.mk,v 1.8 01/01/15 15:24:06 cmf Exp $ */
/*--------------------------------------------*/
...
RM= rm
CC = cc 
CCOPTS	= -Ae $(CCOPTS64) +w1 -D_FILE_OFFSET_BITS=64
...
#ifdef _NOHDF16
	@echo "--> Generation de la bibliotheque simple"
	$(AR) rv $@ $(FIC_VERS_OBJ) $(DEPBIN) $(DEPBIN) $(JPEGOBJECTS)
	ranlib $(DIRBIB)/cai_couche_ima.a
#endif
...
$(JPEGOBJECTS):
	(CC=cc; cd  $(JPEGDIR) ;make -f makefile.cai clean;  make -f makefile.cai CC='$(CC)' 'CCOPTS=$(CCOPTS)' )
