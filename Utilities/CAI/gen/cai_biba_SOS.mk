...
/* Version : $Header: cai_biba_SOS.mk,v 1.6 01/01/15 15:24:08 cmf Exp $ */
/*-------------------------------------------*/
...
JPEGOBJECTS$(JPEGOBJECTS):
	(CC=cc; cd  $(JPEGDIR) ;make -f makefile.cai clean;  make -f makefile.cai CC='$(CC)' )
= $(JPEGDIR)/jcomapi.o $(JPEGDIR)/jutils.o $(JPEGDIR)/jerror.o $(JPEGDIR)/jmemmgr.o \
...
${ALL1} : $(DEPBIN) $(LIBHDF) $(DIRINC)/cai_image.h $(JPEGOBJECTS)
