...
namespace liblas { namespace property_tree
{
    ...
    public:
         ...
         */
        template<class Type, class Translator>
        ::boost::optional<Type> get_value_optional(Translator tr) const;
        ...
        */
        template<class Type, class Translator>
        ::boost::optional<Type> get_optional(const path_type &path, Translator tr) const;
        ...
        */
        template<class Type>
        ::boost::optional<Type> get_optional(const path_type &path) const;
