...
set(CTEST_BUILD_NAME "${BUILD_NAME_PREFIX}-$ENV{TRAVIS_BRANCH}-$ENV{CC}-${CTEST_BUILD_CONFIGURATION}")
...
if(DEFINED ENV{MAKE_CMD})
  ...
  message(FATAL_ERROR "MAKE_CMD evironment variable is not defined")
endif()

if(DEFINED ENV{CMAKE_GEN})
  set(CTEST_CMAKE_GENERATOR "$ENV{CMAKE_GEN}")
else()
  message(FATAL_ERROR "CMAKE_GEN evironment variable is not defined")
endif()
