...
\item Install OTB
  \begin{verbatim}
      cd INSTALL_DIR
      gunzip OrfeoToolbox-3.2.0.tgz
      tar xvf OrfeoToolbox-3.2.0.tar
      mkdir OTB-Binary
      cd OTB-Binary
      ccmake ../OrfeoToolbox-3.2.0
      --> follow the CMake instructions, in particular:
	  --> set BUILD_EXAMPLES to ON within CMake
...
2.8.0 came out in January 2009 and the 3.0.0 in May 2009. The current one is 3.2.0.
