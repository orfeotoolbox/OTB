...
Apparently, there are some issues on Open Solaris with libLAS (library included
...
Tests data are also versioned using Mercurial (see \ref{sec:FAQMercurial}).
...
2.8.0 came out in January 2009. The current one is 3.0.0.
...
2.0.0 was available at the end of 2007, version 3.0.0 way released
