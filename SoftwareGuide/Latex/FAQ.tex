...
This will add the missing headers to the the Gdal include directory, so that your Gdal installation now provide a full Tiff support (headers and symbols). During OTB configuration, be careful to use Gdal include directory as TIFF_INCLUDE_DIRS and GEOTIFF_INCLUDE_DIRS.
