...
\item Install OTB
  ...
  can set \texttt{BUILD_EXAMPLES} to \texttt{OFF}.
      
  After these steps, you have the source of OTB in \texttt{INSTALL_DIR/OrfeoToolbox-2.0.0}
  and the compiled binaries and libraries in \texttt{INSTALL_DIR/OTB-Binary}. Keeping
  ...
  its sources are and you will need to point only to the \texttt{INSTALL_DIR/OTB-Binary}
...
You will also benefit from the strengths of OTB: multiplateform, streaming and 
threading, etc.
