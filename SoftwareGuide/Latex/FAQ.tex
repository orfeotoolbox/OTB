...
\item Install OTB
  \begin{verbatim}
	  ...
	  --> set FLTK_DIR to INSTALL_DIR/Fltk-Binary within CMake OR
	      ...
	      OTB_USE_EXTERNAL_FLTK to OFF. If you don't have FLTK and don't want to use 
  ...
  can set \texttt{BUILD\_EXAMPLES} to \texttt{OFF}. 

  After these steps, you have the source of OTB in \texttt{INSTALL\_DIR/OrfeoToolbox-3.12.0}
...
directly in the OTB_SRC_DIR/Applications directory.
