...
\item Install GDAL (or use your distribution package)
  \begin{verbatim}
      cd INSTALL_DIR
...
\item Install CMake (or use your distribution package)
  \begin{verbatim}
      cd INSTALL_DIR
...
\item Install Fltk (optional) using CMake (do not use the configure script) (or use your distribution package)
  \begin{verbatim}
      cd INSTALL_DIR
