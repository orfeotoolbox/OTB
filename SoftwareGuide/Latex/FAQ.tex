...
\subsection{Am I forced to contribute my code based on OTB into the official repo?}
...
Data used for the tests are also versioned using Git (see \ref{sec:FAQMercurial}).
...
The first version was 1.0.0 in July 2006.The current one is 5.2.0.
