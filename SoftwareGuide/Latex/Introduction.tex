\chapter{Bienvenue}
\label{chapter:Bienvenue}

Bienvenue dans le l'\emph{guide de l'ORFEO ToolBox (OTB)}.

Ce document vous pr\'{e}sente les concepts importants utilis\'{e}s dans l'OTB et 
vous guide efficacement dans son apprentissage et son utilisation. 
De plus, la documentation au format Doxygen du code source de l'OTB est \'{e}galement accessible.


\section{Organisation}
\label{sec:Organisation}

Ce guide logiciel est divis\'{e} en trois parties, chacune \'{e}tant divis\'{e}e en chapitres.
