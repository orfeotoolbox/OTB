...
Using Git, you can easily navigate through the different versions. For instance, this brings you to the 5.2 source code version:
\begin{verbatim}
...
You an find more information on the OTB git workflow in the \href{http://wiki.orfeo-toolbox.org/index.php/Git}{wiki}.
