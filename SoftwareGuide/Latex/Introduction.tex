...
are available from \code{OTB-Applications}. However, the \code{OTB-Applications}
module is now deprecated and replaced by the set of applications that you
will find directly in the \code{OTB/Applications} subdirectory of the \code{OTB} 
module. Usually you will work with the
...
deprecated \code{OTB-Applications} module should only be downloaded and
compiled once the \code{OTB} module is functioning properly.
...
The deprecated \code{OTB-Applications} module contains large, relatively complex
examples of OTB usage, that have been replaced by the \code{Applications} subdirectory 
in the \code{OTB} module.
%%  See the web pages at
%% \url{http://www.itk.org/HTML/Applications.htm}\textbf{FIXME} for a
%% description. Some of
