...
\begin{itemize}
  ...
  \item \code{OTB/Modules/Feature}---various lcoal descriptors and features.
  ...
  \item \code{OTB/Modules/ThirdParty}---cmake scripts to prepare the compilation of OTB and its dependencies (third parties). 
  \item \code{OTB/Modules/Wrappers}---wrappers of applications in several access points (command-line, QT Gui, SWIG\ldots). 
\end{itemize}
