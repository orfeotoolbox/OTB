...
\begin{figure}
   \center
   \includegraphics[width=0.44\textwidth]{monteverdi_optical_calibration.eps}
...
\begin{figure}
   \center
   \includegraphics[width=0.44\textwidth]{monteverdi_optical_calibration_outputs.eps}
...
\begin{figure}
   \center
   \includegraphics[width=0.44\textwidth]{monteverdi_band_math_substraction.eps}
...
\begin{figure}
   \center
   \includegraphics[width=0.44\textwidth]{monteverdi_NDWI2_substraction.eps}
...
\begin{figure}
   \center
   \includegraphics[width=0.44\textwidth]{monteverdi_mean_shift.eps}
