...
The project is based on CMake, GCC-XML. SWIG, CableSwig and finally OTB that must be already built.
...
For instance, this directory contains the modules otbImages and otbLearning. The jar produced will be org.otb.otbimages and 
