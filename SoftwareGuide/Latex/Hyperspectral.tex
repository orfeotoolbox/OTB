...
Constrained Least Square (FCLS)\doxygen{otb}{FCLSUnmixingImageFilter} [Heinz2001]. VSS includes an specific algorithm
...
\end{itemize} 
\end{itemize} 
Principle of RX and GMRF can be resume with the following figures.
(TODO do block diagramm of algorithms)
...
test works on a sliding window (see Figure). This
...
(TODO block diagram for windowing)
