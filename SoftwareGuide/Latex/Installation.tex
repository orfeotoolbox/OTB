...
\hline
\end{tabular}
\caption{Optional capabilities and related modules.}
\label{tab:optional}
\end{table}
\end{tiny}
\end{center}

Every cmake variable mentionned in this subsection are set to ON by default, except OTB\_USE\_MAPNIK; this means that, by default, all the modules indicated in table \ref{tab:instroduction1} (section \ref{sec:DirectoryStructure}) are built,
except OTBMapnik and OTBVectorDataRendering.
