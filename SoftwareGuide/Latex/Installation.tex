...
Some are mandatory, meaning that OTB cannot be compiled without them, while other are optional and can be activated or
...
common cmake variables between super and normal: examples, tests, etc.
