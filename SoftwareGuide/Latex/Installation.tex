...
(*) To provide an overview on how things work, the otion COMPONENTS of the cmake command find_package is used in order to only load the requested modules.
...
Until this problem is addressed, users of this plateform should disable the option OTB_USE_KML, so that OTB won't be built with this third-party.
