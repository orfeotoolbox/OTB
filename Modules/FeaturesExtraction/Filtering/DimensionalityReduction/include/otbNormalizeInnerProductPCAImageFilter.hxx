...
NormalizeInnerProductPCAImageFilter<TInputImage, TOutputImage>::NormalizeInnerProductPCAImageFilter()
{
 ...
 */
template <class TInputImage, class TOutputImage>
void NormalizeInnerProductPCAImageFilter<TInputImage, TOutputImage>::GenerateOutputInformation(void)
{
 ...
 */
template <class TInputImage, class TOutputImage>
void NormalizeInnerProductPCAImageFilter<TInputImage, TOutputImage>::BeforeThreadedGenerateData()
{
  ...
  {
    itkExceptionMacro(<< "Covariance matrix with size (" << cov.Rows() << "," << cov.Cols() << ") is incompatible with mean vector with size" << means.Size());
  }
...
template <class TInputImage, class TOutputImage>
void NormalizeInnerProductPCAImageFilter<TInputImage, TOutputImage>::PrintSelf(std::ostream& os, itk::Indent indent) const
{
