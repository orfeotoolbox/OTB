 ...
 */
template <class TFixedImage, class TMovingImage, class TDisplacementField>
void NCCRegistrationFunction<TFixedImage, TMovingImage, TDisplacementField>::PrintSelf(std::ostream& os, itk::Indent indent) const
{
 ...
 */
template <class TFixedImage, class TMovingImage, class TDisplacementField>
void NCCRegistrationFunction<TFixedImage, TMovingImage, TDisplacementField>::InitializeIteration()
{
  ...
  otbMsgDevMacro(" total metric " << m_MetricTotal << " field size " << this->GetDisplacementField()->GetLargestPossibleRegion().GetSize() << " image size "
...
NCCRegistrationFunction<TFixedImage, TMovingImage, TDisplacementField>::ComputeUpdate(const NeighborhoodType& it, void* itkNotUsed(globalData),
                                                                                      const FloatOffsetType& itkNotUsed(offset))
{
  ...
  itk::NeighborhoodIterator<FixedImageType> hoodIt(hradius, img, img->GetRequestedRegion());
