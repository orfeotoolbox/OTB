...
std::string CommandLineParser::GetPathsAsString(const std::vector<std::string>& vexp)
{
  std::string              res;
...
std::string CommandLineParser::GetPathsAsString(const std::string& exp)
{
  std::string res;
...
CommandLineParser::ParseResultType CommandLineParser::GetPaths(std::vector<std::string>& paths, const std::vector<std::string>& exp)
{
  if (exp.empty())
  {
    return NOMODULEPATH;
...
CommandLineParser::ParseResultType CommandLineParser::GetPaths(std::vector<std::string>& paths, const std::string& exp)
{
...
CommandLineParser::ParseResultType CommandLineParser::GetModuleName(std::string& modName, const std::vector<std::string>& exp)
{
  if (exp.empty())
  {
    return NOMODULENAME;
...
std::vector<std::string> CommandLineParser::GetKeyList(const std::vector<std::string>& exp)
{
...
std::vector<std::string> CommandLineParser::GetKeyList(const std::string& exp)
{
  std::vector<std::string> keyList;
...
bool CommandLineParser::IsAValidKey(const std::string& foundKey)
{
  bool        res = false;
