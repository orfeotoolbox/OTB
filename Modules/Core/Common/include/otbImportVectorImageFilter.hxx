 ...
 */
template <class TOutputImage>
void ImportVectorImageFilter<TOutputImage>::PrintSelf(std::ostream& os, itk::Indent indent) const
{
  int i;
...
template <class TOutputImage>
void ImportVectorImageFilter<TOutputImage>::SetImportPointer(TPixel* ptr, unsigned long num, bool LetFilterManageMemory)
{
 ...
 */
template <class TOutputImage>
typename ImportVectorImageFilter<TOutputImage>::TPixel* ImportVectorImageFilter<TOutputImage>::GetImportPointer()
{
 ...
 */
template <class TOutputImage>
void ImportVectorImageFilter<TOutputImage>::EnlargeOutputRequestedRegion(itk::DataObject* output)
{
 ...
 */
template <class TOutputImage>
void ImportVectorImageFilter<TOutputImage>::GenerateOutputInformation()
{
  // call the superclass' implementation of this method
 ...
 */
template <class TOutputImage>
void ImportVectorImageFilter<TOutputImage>::GenerateData()
{
 ...
 */
template <class TOutputImage>
void ImportVectorImageFilter<TOutputImage>::SetSpacing(const SpacingType& spacing)
{
 ...
 */
template <class TOutputImage>
void ImportVectorImageFilter<TOutputImage>::SetOrigin(const OriginType& origin)
{
...
//----------------------------------------------------------------------------
template <class TOutputImage>
void ImportVectorImageFilter<TOutputImage>::SetDirection(const DirectionType direction)
{
  bool modified = false;
