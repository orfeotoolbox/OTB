 ...
 */
template <class TInputImage, class TOutputImage, class TFunction>
void UnaryFunctorNeighborhoodVectorImageFilter<TInputImage, TOutputImage, TFunction>::GenerateOutputInformation(void)
{
                                                                                                           ...
                                                                                                           itk::ThreadIdType threadId)
{
  ...
  NeighborhoodIteratorType                           neighInputIt(this->GetRadius(), this->GetInput(), inputRegionForThread);
