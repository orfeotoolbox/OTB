...
class OTBCommon_EXPORT_TEMPLATE ImageRegionTileMapSplitter : public itk::ImageRegionSplitter<VImageDimension>
{
public:
...
extern template class OTBCommon_EXPORT_TEMPLATE ImageRegionTileMapSplitter<2>;
