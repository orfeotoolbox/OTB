...
void ExtendedFilenameHelper::SetExtendedFileName(const char* extFname)
{
  if (extFname == nullptr)
  {
...
void ExtendedFilenameHelper::SetExtendedFileName(const std::string& extFname)
{
...
const ExtendedFilenameHelper::OptionMapType& ExtendedFilenameHelper::GetOptionMap(void) const
{
...
ExtendedFilenameHelper::GenericBandRange::GenericBandRange(int a) : std::pair<int, int>(a, a)
{
}

ExtendedFilenameHelper::GenericBandRange::GenericBandRange(const std::pair<int, int>& a) : std::pair<int, int>(a)
{
...
ExtendedFilenameHelper::GenericBandRange::GenericBandRange(int a, int b) : std::pair<int, int>(a, b)
{
  if (b >= 0 && b < a)
  {
    throw std::range_error("Invalid range");
...
bool ExtendedFilenameHelper::GenericBandRange::SetString(const std::string& str, size_t start, size_t size)
{
...
void ExtendedFilenameHelper::GenericBandRange::Print(std::ostream& os)
{
  if (this->first)
  {
    os << this->first;
...
std::vector<ExtendedFilenameHelper::GenericBandRange> ExtendedFilenameHelper::GetGenericBandRange(const std::string& bandRange) const
{
...
bool ExtendedFilenameHelper::ResolveBandRange(const std::string& bandRange, const unsigned int& nbBands, std::vector<unsigned int>& output) const
{
  output.clear();
