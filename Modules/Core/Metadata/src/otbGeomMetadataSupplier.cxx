...
std::string GeomMetadataSupplier::GetMetadataValue(std::string const& path, bool& hasValue, int itkNotUsed(band)) const
{
...
std::string GeomMetadataSupplier::GetResourceFile(std::string const& itkNotUsed(s)) const
{
