...
{
  this->RegisterOverride("OpticalImageMetadataInterface", "otbPleiadesNeoImageMetadataInterface", "Pleiades Neo Metadata Interface", 1,
...
const char* PleiadesNeoImageMetadataInterfaceFactory::GetDescription() const
{
  return "Pleiades Neo Metadata Interface Factory, handle Pleiades Neo metadata in OTB";
}
