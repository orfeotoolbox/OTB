...
MinMaxAttributesLabelMapFilter<TInputImage>::MinMaxAttributesLabelMapFilter()
{
...
MinMaxAttributesLabelMapFilter<TInputImage>::MakeOutput(DataObjectPointerArraySizeType i)
{
...
template <class TInputImage>
typename MinMaxAttributesLabelMapFilter<TInputImage>::AttributesMapObjectType* MinMaxAttributesLabelMapFilter<TInputImage>::GetMinimumOutput()
{
  return static_cast<AttributesMapObjectType*>(this->itk::ProcessObject::GetOutput(1));
}

template <class TInputImage>
const typename MinMaxAttributesLabelMapFilter<TInputImage>::AttributesMapObjectType* MinMaxAttributesLabelMapFilter<TInputImage>::GetMinimumOutput() const
{
  return static_cast<const AttributesMapObjectType*>(this->itk::ProcessObject::GetOutput(1));
}

template <class TInputImage>
typename MinMaxAttributesLabelMapFilter<TInputImage>::AttributesMapObjectType* MinMaxAttributesLabelMapFilter<TInputImage>::GetMaximumOutput()
{
  return static_cast<AttributesMapObjectType*>(this->itk::ProcessObject::GetOutput(2));
}

template <class TInputImage>
const typename MinMaxAttributesLabelMapFilter<TInputImage>::AttributesMapObjectType* MinMaxAttributesLabelMapFilter<TInputImage>::GetMaximumOutput() const
{
  return static_cast<const AttributesMapObjectType*>(this->itk::ProcessObject::GetOutput(2));
}

template <class TInputImage>
void MinMaxAttributesLabelMapFilter<TInputImage>::GenerateData()
{
