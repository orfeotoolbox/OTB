...
#ifndef otbSpot5ForwardTransform_h
#define otbSpot5ForwardTransform_h
...
class ITK_EXPORT Spot5ForwardTransform : public Spot5TransformBase<TScalarType, NInputDimensions, NOutputDimensions>
{
public:
  ...
  itkTypeMacro(Spot5ForwardTransform, Spot5TransformBase);
...
#include "otbSpot5ForwardTransform.hxx"
#endif
