...
void OGRIOHelper::ConvertOGRLayerToDataTreeNode(OGRLayer* layer, DataNodePointerType document, VectorDataPointerType dataTree) const
{
  ...
  while ((feature = layer->GetNextFeature()) != nullptr)
  {
    ...
    case wkbPoint:
    {
      ...
      dataTree->Add(dataNode,document);
      break;
    }
    case wkbPoint25D:
    {
