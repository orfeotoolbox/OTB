...
template <class TImage, class TVectorData>
void ListSampleGenerator<TImage, TVectorData>::SetInput(const ImageType* image)
{
  this->ProcessObject::SetNthInput(0, const_cast<ImageType*>(image));
}

template <class TImage, class TVectorData>
const TImage* ListSampleGenerator<TImage, TVectorData>::GetInput() const
{
...
template <class TImage, class TVectorData>
void ListSampleGenerator<TImage, TVectorData>::SetInputVectorData(const VectorDataType* vectorData)
{
...
template <class TImage, class TVectorData>
const TVectorData* ListSampleGenerator<TImage, TVectorData>::GetInputVectorData() const
{
...
template <class TImage, class TVectorData>
typename ListSampleGenerator<TImage, TVectorData>::DataObjectPointer ListSampleGenerator<TImage, TVectorData>::MakeOutput(DataObjectPointerArraySizeType idx)
{
...
template <class TImage, class TVectorData>
typename ListSampleGenerator<TImage, TVectorData>::ListSampleType* ListSampleGenerator<TImage, TVectorData>::GetTrainingListSample()
{
  return dynamic_cast<ListSampleType*>(this->itk::ProcessObject::GetOutput(0));
}
// Get the Training label ListSample
template <class TImage, class TVectorData>
typename ListSampleGenerator<TImage, TVectorData>::ListLabelType* ListSampleGenerator<TImage, TVectorData>::GetTrainingListLabel()
{
...
template <class TImage, class TVectorData>
typename ListSampleGenerator<TImage, TVectorData>::ListSampleType* ListSampleGenerator<TImage, TVectorData>::GetValidationListSample()
{
...
template <class TImage, class TVectorData>
typename ListSampleGenerator<TImage, TVectorData>::ListLabelType* ListSampleGenerator<TImage, TVectorData>::GetValidationListLabel()
{
  return dynamic_cast<ListLabelType*>(this->itk::ProcessObject::GetOutput(3));
}

template <class TImage, class TVectorData>
void ListSampleGenerator<TImage, TVectorData>::GenerateInputRequestedRegion()
{
...
template <class TImage, class TVectorData>
void ListSampleGenerator<TImage, TVectorData>::GenerateData()
{
  // Get the inputs
    ...
    if (itVector.Get()->IsPolygonFeature())
    {
      ...
      for (it.GoToBegin(); !it.IsAtEnd(); ++it)
      {
        ...
        if (exteriorRing->IsInside(point) || (this->GetPolygonEdgeInclusion() && exteriorRing->IsOnEdge(point)))
        {
          ...
          {
            if (interiorRing.Get()->IsInside(point) || (this->GetPolygonEdgeInclusion() && interiorRing.Get()->IsOnEdge(point)))
            {
...
template <class TImage, class TVectorData>
void ListSampleGenerator<TImage, TVectorData>::GenerateClassStatistics()
{
  m_ClassesSize.clear();
...
template <class TImage, class TVectorData>
void ListSampleGenerator<TImage, TVectorData>::ComputeClassSelectionProbability()
{
...
template <class TImage, class TVectorData>
double ListSampleGenerator<TImage, TVectorData>::GetPolygonAreaInPixelsUnits(DataNodeType* polygonDataNode, ImageType* image)
{
...
template <class TImage, class TVectorData>
void ListSampleGenerator<TImage, TVectorData>::PrintSelf(std::ostream& os, itk::Indent indent) const
{
  ...
  else
  {
    ...
    for (std::map<ClassLabelType, double>::const_iterator itmap = m_ClassesProbTraining.begin(); itmap != m_ClassesProbTraining.end(); ++itmap)
    {
      os << indent << itmap->first << ": " << itmap->second << "\n";
    }
    os << indent << "** Number of selected samples:\n";
    for (std::map<ClassLabelType, int>::const_iterator itmap = m_ClassesSamplesNumberTraining.begin(); itmap != m_ClassesSamplesNumberTraining.end(); ++itmap)
    {
      os << indent << itmap->first << ": " << itmap->second << "\n";
    }
  }
  ...
  {
    os << indent << "** Selection probability:\n";
    for (std::map<ClassLabelType, double>::const_iterator itmap = m_ClassesProbValidation.begin(); itmap != m_ClassesProbValidation.end(); ++itmap)
    {
      os << indent << itmap->first << ": " << itmap->second << "\n";
    }
    os << indent << "** Number of selected samples:\n";
    for (std::map<ClassLabelType, int>::const_iterator itmap = m_ClassesSamplesNumberValidation.begin(); itmap != m_ClassesSamplesNumberValidation.end();
         ++itmap)
    {
      os << indent << itmap->first << ": " << itmap->second << "\n";
    }
