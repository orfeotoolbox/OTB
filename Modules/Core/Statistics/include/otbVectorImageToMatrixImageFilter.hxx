...
template <class TInputImage>
itk::DataObject::Pointer PersistentVectorImageToMatrixFilter<TInputImage>::MakeOutput(DataObjectPointerArraySizeType output)
{
  switch (output)
  {
  case 0:
...
template <class TInputImage>
typename PersistentVectorImageToMatrixFilter<TInputImage>::MatrixObjectType* PersistentVectorImageToMatrixFilter<TInputImage>::GetMatrixOutput()
{
  return static_cast<MatrixObjectType*>(this->itk::ProcessObject::GetOutput(1));
}

template <class TInputImage>
const typename PersistentVectorImageToMatrixFilter<TInputImage>::MatrixObjectType* PersistentVectorImageToMatrixFilter<TInputImage>::GetMatrixOutput() const
{
  return static_cast<const MatrixObjectType*>(this->itk::ProcessObject::GetOutput(1));
}

template <class TInputImage>
void PersistentVectorImageToMatrixFilter<TInputImage>::GenerateOutputInformation()
{
...
template <class TInputImage>
void PersistentVectorImageToMatrixFilter<TInputImage>::AllocateOutputs()
{
...
template <class TInputImage>
void PersistentVectorImageToMatrixFilter<TInputImage>::Reset()
{
  TInputImage* inputPtr = const_cast<TInputImage*>(this->GetInput());
  inputPtr->UpdateOutputInformation();

  this->GetMatrixOutput()->Get().set_size(inputPtr->GetNumberOfComponentsPerPixel(), inputPtr->GetLargestPossibleRegion().GetNumberOfPixels());
}

template <class TInputImage>
void PersistentVectorImageToMatrixFilter<TInputImage>::Synthetize()
{
}
...
void PersistentVectorImageToMatrixFilter<TImage>::PrintSelf(std::ostream& os, itk::Indent indent) const
{
