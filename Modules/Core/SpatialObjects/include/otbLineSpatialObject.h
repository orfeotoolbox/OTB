...
public:
  ...
  const SpatialObjectPointType* GetPoint(unsigned long id) const override
  {
    return &(m_Points[id]);
  }

  /** Return a point in the list given the index */
  SpatialObjectPointType* GetPoint(unsigned long id) override
  {
    return &(m_Points[id]);
  }

  /** Return the number of points in the list */
  itk::SizeValueType GetNumberOfPoints(void) const override
  {
