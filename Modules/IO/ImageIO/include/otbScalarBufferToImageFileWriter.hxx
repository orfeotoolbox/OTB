...
ScalarBufferToImageFileWriter<TBufferType, TOutputPixelType>::ScalarBufferToImageFileWriter()
  : m_Buffer(nullptr), m_NumberOfChannels(0), m_InverseXSpacing(false)
{
...
template <class TBufferType, class TOutputPixelType>
void ScalarBufferToImageFileWriter<TBufferType, TOutputPixelType>::GenerateData()
{
...
template <class TBufferType, class TOutputPixelType>
void ScalarBufferToImageFileWriter<TBufferType, TOutputPixelType>::PrintSelf(std::ostream& os, itk::Indent indent) const
{
