...
int otbImageFileWriterWithExtendedOptionBox(int itkNotUsed(argc), char* argv[])
{
  ...
  typedef otb::MultiChannelExtractROI<InputImageType::InternalPixelType, InputImageType::InternalPixelType> ExtractROIFilterType;
  ...
  outputFilenameExtended << outputFilename << "?&box=" << startx << separator << starty << separator << sizex << separator << sizey;
