...
VectorDataFileReader<TOutputVectorData>::VectorDataFileReader() : m_VectorDataIO(nullptr), m_UserSpecifiedVectorDataIO(false), m_FileName("")
{
}
 ...
 */
template <class TOutputVectorData>
VectorDataFileReader<TOutputVectorData>::~VectorDataFileReader()
{
}
...
template <class TOutputVectorData>
void VectorDataFileReader<TOutputVectorData>::TestFileExistenceAndReadability()
{
  ...
  if (!itksys::SystemTools::FileExists(this->m_FileName))
  {
    ...
    msg << "The file doesn't exist. " << std::endl << "Filename = " << this->m_FileName << std::endl;
...
template <class TOutputVectorData>
void VectorDataFileReader<TOutputVectorData>::SetVectorDataIO(VectorDataIOBaseType* vectorDataIO)
{
...
template <class TOutputVectorData>
void VectorDataFileReader<TOutputVectorData>::GenerateOutputInformation(void)
{
...
template <class TOutputVectorData>
void VectorDataFileReader<TOutputVectorData>::GenerateData()
{
...
template <class TOutputVectorData>
void VectorDataFileReader<TOutputVectorData>::PrintSelf(std::ostream& os, itk::Indent indent) const
{
