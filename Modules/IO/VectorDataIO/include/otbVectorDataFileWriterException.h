...
#ifndef otbVectorDataFileWriterException_h
#define otbVectorDataFileWriterException_h
 ...
 */
class OTBVectorDataIO_EXPORT VectorDataFileWriterException : public itk::ExceptionObject
{
public:
