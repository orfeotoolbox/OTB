...
int otbMNFImageFilterTest(int, char* argv[])
{
  ...
  */
  ...
  // Image filtering
  typedef otb::MNFImageFilter<ImageType, ImageType, NoiseFilterType, otb::Transform::FORWARD> FilterType;
  ...
  if (want_inv)
  {
    typedef otb::MNFImageFilter<ImageType, ImageType, NoiseFilterType, otb::Transform::INVERSE> InvFilterType;
