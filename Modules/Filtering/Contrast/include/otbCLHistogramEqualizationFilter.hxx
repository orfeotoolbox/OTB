...
CLHistogramEqualizationFilter<TInputImage, TOutputImage>::CLHistogramEqualizationFilter()
...
template <class TInputImage, class TOutputImage>
void CLHistogramEqualizationFilter<TInputImage, TOutputImage>::UpdateOutputInformation()
{
...
template <class TInputImage, class TOutputImage>
void CLHistogramEqualizationFilter<TInputImage, TOutputImage>::PropagateRequestedRegion(itk::DataObject* output)
{
...
template <class TInputImage, class TOutputImage>
void CLHistogramEqualizationFilter<TInputImage, TOutputImage>::GenerateData()
{
 ...
 */
template <class TInputImage, class TOutputImage>
void CLHistogramEqualizationFilter<TInputImage, TOutputImage>::PrintSelf(std::ostream& os, itk::Indent indent) const
{
