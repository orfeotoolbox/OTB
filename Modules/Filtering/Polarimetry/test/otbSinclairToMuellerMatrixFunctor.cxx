...
int otbSinclairToMuellerMatrixFunctor(int itkNotUsed(argc), char* itkNotUsed(argv)[])
{
  ...
  if (std::abs(result[0] - outputFunct[0]) > 1e-10 || std::abs(result[1] - outputFunct[1]) > 1e-10 || std::abs(result[2] - outputFunct[2]) > 1e-10 ||
      ...
      std::abs(result[9] - outputFunct[9]) > 1e-10 || std::abs(result[10] - outputFunct[10]) > 1e-10 || std::abs(result[11] - outputFunct[11]) > 1e-10 ||
      std::abs(result[12] - outputFunct[12]) > 1e-10 || std::abs(result[13] - outputFunct[13]) > 1e-10 || std::abs(result[14] - outputFunct[14]) > 1e-10 ||
