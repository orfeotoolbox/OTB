...
class ITK_TEMPLATE_EXPORT WaveletFilterBank
...
class ITK_TEMPLATE_EXPORT WaveletFilterBank<TInputImage, TOutputImage, TWaveletOperator, Wavelet::FORWARD>
  : public itk::ImageToImageFilter<TInputImage, TOutputImage>
{
public:
  /** Standard typedefs */
 ...
 */
template <class TInputImage, class TOutputImage, class TWaveletOperator>
class ITK_TEMPLATE_EXPORT WaveletFilterBank<TInputImage, TOutputImage, TWaveletOperator, Wavelet::INVERSE>
  : public itk::ImageToImageFilter<TInputImage, TOutputImage>
{
public:
  /** Standard typedefs */
