...
ROIdataConversion<TInputImage, TInputROIImage>::ROIdataConversion()
{
...
template <class TInputImage, class TInputROIImage>
void ROIdataConversion<TInputImage, TInputROIImage>::GenerateOutputInformation(void)
{
...
template <class TInputImage, class TInputROIImage>
void ROIdataConversion<TInputImage, TInputROIImage>::GenerateInputRequestedRegion(void)
{
...
template <class TInputImage, class TInputROIImage>
void ROIdataConversion<TInputImage, TInputROIImage>::GenerateData()
{
  typename InputImageType::Pointer         inputImagePtr = const_cast<InputImageType*>(this->GetInputImage());
  ...
  itk::ImageRegionConstIterator<InputImageType>    inputIter(inputImagePtr, inputImagePtr->GetRequestedRegion());
  itk::ImageRegionConstIterator<InputROIImageType> trainingIter(inputROIPtr, inputROIPtr->GetRequestedRegion());
  itk::ImageRegionIterator<OutputImageType>        outputIter(outputPtr, outputPtr->GetRequestedRegion());
...
template <class TInputImage, class TInputROIImage>
typename ROIdataConversion<TInputImage, TInputROIImage>::SizeValueType ROIdataConversion<TInputImage, TInputROIImage>::GetNumberOfSample()
{
