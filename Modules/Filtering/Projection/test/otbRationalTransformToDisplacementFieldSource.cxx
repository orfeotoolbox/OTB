...
int otbRationalTransformToDisplacementFieldSourceTest(int argc, char* argv[])
{
  ...
  typedef itk::TransformToDisplacementFieldSource<DisplacementFieldImageType, CoordRepresentationType> DisplacementFieldGeneratorType;
  ...
  DisplacementFieldGeneratorType::OutputImageRegionType outputRegion = defGenerator->GetOutputRegion();
