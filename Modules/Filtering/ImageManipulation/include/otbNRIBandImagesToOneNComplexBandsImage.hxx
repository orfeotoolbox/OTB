 ...
 */
template <class TInputImage, class TOutputImage>
void NRIBandImagesToOneNComplexBandsImage<TInputImage, TOutputImage>::GenerateOutputInformation(void)
{
 ...
 */
template <class TInputImage, class TOutputImage>
void NRIBandImagesToOneNComplexBandsImage<TInputImage, TOutputImage>::BeforeThreadedGenerateData(void)
{
  unsigned int nbInputs = this->GetNumberOfInputs();
...
void NRIBandImagesToOneNComplexBandsImage<TInputImage, TOutput>::PrintSelf(std::ostream& os, itk::Indent indent) const
{
