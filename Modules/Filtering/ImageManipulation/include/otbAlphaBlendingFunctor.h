...
class ITK_TEMPLATE_EXPORT AlphaBlendingFunctorBase
{
public:
...
template<class TInputPixel1, class TInputPixel2, class TOutputPixel>
class ITK_TEMPLATE_EXPORT AlphaBlendingFunctor
...
class ITK_TEMPLATE_EXPORT AlphaBlendingFunctor< itk::RGBAPixel<TInputInternalPixel1>,
