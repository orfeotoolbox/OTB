 ...
 */
template <class TInputImage, class TOutputImage>
void TwoNRIBandsImageToNComplexBandsImage<TInputImage, TOutputImage>::GenerateOutputInformation(void)
{
 ...
 */
template <class TInputImage, class TOutputImage>
void TwoNRIBandsImageToNComplexBandsImage<TInputImage, TOutputImage>::BeforeThreadedGenerateData(void)
{
  unsigned int nbCompo = this->GetInput()->GetNumberOfComponentsPerPixel();
...
void TwoNRIBandsImageToNComplexBandsImage<TInputImage, TOutput>::PrintSelf(std::ostream& os, itk::Indent indent) const
{
