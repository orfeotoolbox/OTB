 ...
 */
template <class TInputImage>
void PersistentCompareImageFilter<TInputImage>::SetInput1(const TInputImage* image)
{
 ...
 */
template <class TInputImage>
void PersistentCompareImageFilter<TInputImage>::SetInput2(const TInputImage* image)
{
  // The ProcessObject is not const-correct so the const_cast is required here
...
template <class TInputImage>
const TInputImage* PersistentCompareImageFilter<TInputImage>::GetInput1()
{
...
template <class TInputImage>
const TInputImage* PersistentCompareImageFilter<TInputImage>::GetInput2()
{
...
template <class TInputImage>
typename itk::DataObject::Pointer PersistentCompareImageFilter<TInputImage>::MakeOutput(DataObjectPointerArraySizeType output)
{
  switch (output)
  {
  case 0:
...
template <class TInputImage>
typename PersistentCompareImageFilter<TInputImage>::RealObjectType* PersistentCompareImageFilter<TInputImage>::GetPSNROutput()
{
  return static_cast<RealObjectType*>(this->itk::ProcessObject::GetOutput(1));
}

template <class TInputImage>
const typename PersistentCompareImageFilter<TInputImage>::RealObjectType* PersistentCompareImageFilter<TInputImage>::GetPSNROutput() const
{
  return static_cast<const RealObjectType*>(this->itk::ProcessObject::GetOutput(1));
}

template <class TInputImage>
typename PersistentCompareImageFilter<TInputImage>::RealObjectType* PersistentCompareImageFilter<TInputImage>::GetMSEOutput()
{
  return static_cast<RealObjectType*>(this->itk::ProcessObject::GetOutput(2));
}

template <class TInputImage>
const typename PersistentCompareImageFilter<TInputImage>::RealObjectType* PersistentCompareImageFilter<TInputImage>::GetMSEOutput() const
{
  return static_cast<const RealObjectType*>(this->itk::ProcessObject::GetOutput(2));
}

template <class TInputImage>
typename PersistentCompareImageFilter<TInputImage>::RealObjectType* PersistentCompareImageFilter<TInputImage>::GetMAEOutput()
{
  return static_cast<RealObjectType*>(this->itk::ProcessObject::GetOutput(3));
}

template <class TInputImage>
const typename PersistentCompareImageFilter<TInputImage>::RealObjectType* PersistentCompareImageFilter<TInputImage>::GetMAEOutput() const
{
  return static_cast<const RealObjectType*>(this->itk::ProcessObject::GetOutput(3));
}

template <class TInputImage>
typename PersistentCompareImageFilter<TInputImage>::RealObjectType* PersistentCompareImageFilter<TInputImage>::GetDiffCountOutput()
{
  return static_cast<RealObjectType*>(this->itk::ProcessObject::GetOutput(4));
}

template <class TInputImage>
const typename PersistentCompareImageFilter<TInputImage>::RealObjectType* PersistentCompareImageFilter<TInputImage>::GetDiffCountOutput() const
{
  return static_cast<const RealObjectType*>(this->itk::ProcessObject::GetOutput(4));
}

template <class TInputImage>
void PersistentCompareImageFilter<TInputImage>::GenerateOutputInformation()
{
...
template <class TInputImage>
void PersistentCompareImageFilter<TInputImage>::AllocateOutputs()
{
...
template <class TInputImage>
void PersistentCompareImageFilter<TInputImage>::Synthetize()
{
  int           i;
  unsigned long count;
  ...
  // compute psnr
  psnr = (std::abs(mse) > 0.0000000001 && (maximumRef - minimumRef) > 0.0000000001)
             ? 10. * std::log10(((maximumRef - minimumRef) * (maximumRef - minimumRef)) / mse)
             : 0.;
  // Set the output
...
template <class TInputImage>
void PersistentCompareImageFilter<TInputImage>::ThreadedGenerateData(const RegionType& outputRegionForThread, itk::ThreadIdType threadId)
{
  /**
   * Grab the input
   */
...
void PersistentCompareImageFilter<TImage>::PrintSelf(std::ostream& os, itk::Indent indent) const
{
