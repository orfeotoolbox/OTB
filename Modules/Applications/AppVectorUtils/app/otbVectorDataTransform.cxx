...
public:
  ...
  /** Convenient typedefs */
  typedef otb::VectorDataTransformFilter<VectorDataType, VectorDataType>  VectorDataTransformFilterType;
...
private:
  void DoInit() override
  {
    ...
    SetDocLongDescription(
        "This application iterates over each vertex in the "
    ...
    SetParameterDescription("in",
                            "Image defining the reference coordinate "
    ...
    SetParameterDescription("transform.centerx",
                            "X coordinate of the rotation "
                            "and scaling center (in physical units)");
    AddParameter(ParameterType_Float, "transform.centery", "Center Y");
    SetParameterDescription("transform.centery",
                            "Y coordinate of the rotation "
                            "and scaling center (in physical units)");
