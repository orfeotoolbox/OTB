...
private:
  void DoInit() override
  {
    ...
    SetDescription(
        "Computes Structural Feature Set textures on every pixel of the "
        "input image selected channel");

    // Documentation
    SetDocLongDescription(
        "Structural Feature Set [1] are based on the histograms of "
    ...
    SetDocSeeAlso(
        "[1] HUANG, Xin, ZHANG, Liangpei, et LI, Pingxiang. Classification and extraction "
    ...
    SetParameterDescription("parameters",
                            "This group of parameters allows one to define SFS texture "
