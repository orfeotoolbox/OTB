...
private:
  ...
  void DoExecute() override
  {
    ...
    itk::ExposeMetaData<ImageIOBase::IOComponentType>(inImage->GetMetaDataDictionary(), MetaDataKey::DataType, typeInfo);
    ...
    ossOutput << "\tEstimated ground spacing (in meters): [" << GetParameterFloat("estimatedgroundspacingx") << ","
              << GetParameterFloat("estimatedgroundspacingy") << "]" << std::endl;
