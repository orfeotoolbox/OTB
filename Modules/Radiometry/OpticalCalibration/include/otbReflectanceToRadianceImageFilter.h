...
{
public:
  ReflectanceToRadianceImageFunctor() : m_SolarIllumination(1.0), m_IlluminationCorrectionCoefficient(1.0)
  {
  }
...
class ITK_EXPORT ReflectanceToRadianceImageFilter
    : public UnaryImageFunctorWithVectorImageFilter<
          ...
          typename Functor::ReflectanceToRadianceImageFunctor<typename TInputImage::InternalPixelType, typename TOutputImage::InternalPixelType>>
{
public:
  ...
  typedef typename Functor::ReflectanceToRadianceImageFunctor<typename InputImageType::InternalPixelType, typename OutputImageType::InternalPixelType>
      FunctorType;
