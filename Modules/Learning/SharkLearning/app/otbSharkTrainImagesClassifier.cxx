...
class SharkTrainImagesClassifier: public SharkLearningApplicationBase<float,int>
{
public:
  /** Standard class typedefs. */
  typedef SharkTrainImagesClassifier Self;
  typedef SharkLearningApplicationBase<float,int> Superclass;
  ...
  itkTypeMacro(SharkTrainImagesClassifier, otb::Wrapper::SharkLearningApplicationBase)
...
protected:
  ...
  //friend void InitSVMParams(SharkTrainImagesClassifier & app);

private:

  void DoInit()
  {
    SetName("SharkTrainImagesClassifier");
    SetDescription(
...
OTB_APPLICATION_EXPORT(otb::Wrapper::SharkTrainImagesClassifier)
