...
HooverMatrixFilter<TLabelMap>::HooverMatrixFilter() : m_NumberOfRegionsGT(0), m_NumberOfRegionsMS(0)
{
...
template <class TLabelMap>
void HooverMatrixFilter<TLabelMap>::SetGroundTruthLabelMap(const LabelMapType* gt)
{
  this->SetInput(0, gt);
}
...
template <class TLabelMap>
void HooverMatrixFilter<TLabelMap>::SetMachineSegmentationLabelMap(const LabelMapType* ms)
{
  this->SetInput(1, ms);
}
...
template <class TLabelMap>
const TLabelMap* HooverMatrixFilter<TLabelMap>::GetGroundTruthLabelMap()
{
...
template <class TLabelMap>
const TLabelMap* HooverMatrixFilter<TLabelMap>::GetMachineSegmentationLabelMap()
{
  return this->GetInput(1);
}

template <class TLabelMap>
void HooverMatrixFilter<TLabelMap>::BeforeThreadedGenerateData()
{
...
template <class TLabelMap>
void HooverMatrixFilter<TLabelMap>::ThreadedProcessLabelObject(LabelObjectType* labelObject)
{
