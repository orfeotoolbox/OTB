...
class ITK_TEMPLATE_EXPORT ConnectedLabelFunctor
{
...
class ITK_TEMPLATE_EXPORT MeanShiftSegmentationFilter : public itk::ImageToImageFilter<TInputImage, TOutputLabelImage>
{
public:
