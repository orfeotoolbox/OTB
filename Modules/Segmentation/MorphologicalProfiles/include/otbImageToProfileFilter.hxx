 ...
 */
template <class TInputImage, class TOutputImage, class TFilter, class TParameter>
void ImageToProfileFilter<TInputImage, TOutputImage, TFilter, TParameter>::GenerateOutputInformation(void)
{
 ...
 */
template <class TInputImage, class TOutputImage, class TFilter, class TParameter>
void ImageToProfileFilter<TInputImage, TOutputImage, TFilter, TParameter>::GenerateInputRequestedRegion(void)
{
  // Retrieving input/output pointers
  InputImagePointerType      inputPtr  = this->GetInput();
  OutputImageListPointerType outputPtr = this->GetOutput();
 ...
 */
template <class TInputImage, class TOutputImage, class TFilter, class TParameter>
void ImageToProfileFilter<TInputImage, TOutputImage, TFilter, TParameter>::GenerateData(void)
{
  // Retrieving input/output pointers
  InputImagePointerType      inputPtr  = this->GetInput();
  OutputImageListPointerType outputPtr = this->GetOutput();
 ...
 */
template <class TInputImage, class TOutputImage, class TFilter, class TParameter>
void ImageToProfileFilter<TInputImage, TOutputImage, TFilter, TParameter>::PrintSelf(std::ostream& os, itk::Indent indent) const
{
