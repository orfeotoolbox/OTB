...
// .This scientific instrument was launched into Earth orbit by NASA. The MODIS image format is HDF (Hierarchical Data Format). This
...
// A specific feature of this format is that it works with container structures which can hold datasets and other groups. It implies that
// access to these structures in OTB presents some adaptations compare to other image formats.
// OTB is using GDAL to support HDF. HDF4 and HDF5 supports in Gdal is not activated by default. You need to download the HDF run-time
// libraries and compile Gdal by adding the support of these formats. You can find more informations here : \url{http://trac.osgeo.org/gdal/wiki/HDF}
//
//
