...
#ifndef otbCostVolumeImageFilter0_txx
...
CostVolumeImageFilter0<TInputImage,TGradientImage,TOutputImage>
...
// le calcul des entr̩es non shift̩es
    if(inLeftPtr)
      {
...
// le calcul des entr̩es shift̩es    
...
// int i(0); //indice de l'image dans le cube
 ...
 ComputeInputRegions( outputRegionForThread, LeftRegionForThread, RightRegionForThread );	
...
typename RegionType::IndexType  ShiftInv;
  ...
  ShiftInv[0] = -m_HorizontalDisparity;
