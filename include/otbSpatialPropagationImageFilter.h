...
#ifndef otbSpatialPropagationImageFilter_h
#define otbSpatialPropagationImageFilter_h
...
class ITK_EXPORT SpatialPropagationImageFilter :
    public itk::ImageToImageFilter<TInputImage,TOutputImage>
{
public:
  /** Standard class typedef */
  typedef SpatialPropagationImageFilter       Self; 
  ...
  itkTypeMacro(SpatialPropagationImageFilter, ImageToImageFilter); 
...
//=============== Seters ====================================================================================
  ...
  void SetMinPatchOutputImage(const TInputImage * image);
...
protected:
  ...
  /** Destructor */
  ~SpatialPropagationImageFilter() ITK_OVERRIDE;
...
private:
 SpatialPropagationImageFilter(const Self&); //purposely not implemented
 void operator=(const Self&); //purposely not implemeFnted  
 


/** The Aggregated cost */
 typename AggregatedCostType::Pointer m_AggregatedCost;
...
#include "otbSpatialPropagationImageFilter.txx"
#endif
