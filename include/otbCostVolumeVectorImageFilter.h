...
#ifndef otbCostVolumeVectorImageFilter_h
#define otbCostVolumeVectorImageFilter_h
...
class ITK_EXPORT CostVolumeVectorImageFilter :
    public itk::ImageToImageFilter<TInputImage,TOutputImage>
{
public:
  /** Standard class typedef */
  typedef CostVolumeVectorImageFilter       Self; 
  ...
  itkTypeMacro(CostVolumeVectorImageFilter, ImageToImageFilter); 
...
protected:
  ...
  /** Destructor */
  ~CostVolumeVectorImageFilter() ITK_OVERRIDE;
...
private:
  CostVolumeVectorImageFilter(const Self&); //purposely not implemented
...
#include "otbCostVolumeVectorImageFilter.txx"
#endif
