...
public:
	...
	typedef shark::Autoencoder< shark::LinearNeuron, shark::LinearNeuron> AutoencoderType;
	...
	typedef shark::TiedAutoencoder< shark::LinearNeuron, shark::LinearNeuron> TiedAutoencoderType;
