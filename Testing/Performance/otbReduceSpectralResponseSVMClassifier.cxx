...
int main(int argc, char * argv[])
{
   ...
   typedef otb::AtmosphericCorrectionsReduceSpectralResponse < ResponseType,SatRSRType>  AReduceResponseType;
   ...
   typedef AReduceResponseType::AtmosphericCorrectionParametersType  AtmosphericCorrectionParametersType;
