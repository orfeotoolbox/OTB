...
int otbRomaniaReflectanceToRomaniaSurfaceReflectanceImageFilter(int argc, char * argv[])
{
  ...
  std::cout<<corrToRadia->GetOutput()->GetIntrinsicAtmosphericReflectance(0)<<std::endl;
  std::cout<<corrToRadia->GetOutput()->GetIntrinsicAtmosphericReflectance(1)<<std::endl;
  std::cout<<corrToRadia->GetOutput()->GetIntrinsicAtmosphericReflectance(2)<<std::endl;
  std::cout<<corrToRadia->GetOutput()->GetIntrinsicAtmosphericReflectance(3)<<std::endl;
  return EXIT_SUCCESS;
}
