...
std::cout<<"SetAerosolModel"<<param->GetAerosolModel()<<std::endl;
      ...
      for(unsigned int j=0; j<nbChannel; j++)
	{
      ...
      writer->Update();
      std::cout<<corrToRadia->GetOutput()->GetIntrinsicAtmosphericReflectances().size()<<std::endl;
      std::cout<<corrToRadia->GetOutput()->GetIntrinsicAtmosphericReflectances(0)<<std::endl;
      std::cout<<corrToRadia->GetOutput()->GetIntrinsicAtmosphericReflectances(1)<<std::endl;
      std::cout<<corrToRadia->GetOutput()->GetIntrinsicAtmosphericReflectances(2)<<std::endl;
      std::cout<<corrToRadia->GetOutput()->GetIntrinsicAtmosphericReflectances(3)<<std::endl;
    }
