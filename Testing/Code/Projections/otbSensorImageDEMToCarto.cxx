...
/**On stocke les pixel index dans un tableau currentindexarray**/
 ...
 //otbGenericMsgDebugMacro(<< "Altitude:" <<  heightArray[It1] <<std::endl; 	
 It=It+2;
 It1=It1+1;
...
otbGenericMsgDebugMacro(<< "La valeur du pixel est:"<< float(pixelvalue) );
	   
outputimage->SetPixel(currentindexbis,pixelvalue);
DEMimage->SetPixel(currentindexbis,DEMpixelvalue);
otbGenericMsgDebugMacro(<< "Altitude stockée:" <<  heightArray[k] ); 
 	}
