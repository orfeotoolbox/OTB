...
int otbRationalTransformToDeformationFiledSourceTest(int argc, char* argv[])
{
  ...
  typedef otb::Image<VectorPixelType, Dimension >     DeformationFieldImageType;
  ...
  typedef otb::ImageFileWriter<DeformationFieldImageType >   WriterType;
