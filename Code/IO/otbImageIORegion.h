...
=========================================================================*/
#ifndef __otbImageIORegion_h
#define __otbImageIORegion_h
...
class ITK_EXPORT ImageIORegion: public itk::Region
{
public:
  /** Standard class typedefs. */
  typedef otb::ImageIORegion<TType>     Self;
  typedef itk::Region                   Superclass;

  /** Standard part of all itk objects. */
  itkTypeMacro(ImageIORegion, itk:Region);
  ...
  typedef std::vector<Type>  IndexType;

  /** Size typedef support. A size is used to define region bounds. */
  typedef std::vector<Type>  SizeType;
   ...
   * the ImageDimension. */
  Type GetSize(Type i) const
    {
    return m_Size[i];
    }
  Type GetIndex(Type i) const
    {
    return m_Index[i];
    }
  void SetSize(const Type i, Type size)
    {
    m_Size[i] = size;
    }
  void SetIndex(const Type i, Type idx)
    {
    m_Index[i] = idx;
    }
