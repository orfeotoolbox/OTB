...
// Constructeur par défault
  TransMercatorMapProjection::TransMercatorMapProjection()
{
...
void TransMercatorMapProjection::SetEllipsoid() 
{
...
//m_TransMercatorProjection->setAB(6378137.0, 6356752.3142);
}

///Spécification du false easting
void    TransMercatorMapProjection::SetFalseEasting(double falseEasting) 
{
m_TransMercatorProjection->setFalseEasting(falseEasting);
}

///Spécification du false Northing
void    TransMercatorMapProjection::SetFalseNorthing(double falseNorthing) 
{
m_TransMercatorProjection->setFalseNorthing(falseNorthing);
}

///Spécification du scaleFactor
void    TransMercatorMapProjection::SetScaleFactor(double scaleFactor) 
{
m_TransMercatorProjection->setScaleFactor(scaleFactor);
}

///Instanciation de tous les paramètres
void    TransMercatorMapProjection::SetParameters(double falseEasting,double falseNorthing,double scaleFactor) 
{
...
void    TransMercatorMapProjection::SetDefaults() 
{
m_TransMercatorProjection->setDefaults();
}

///Instanciation avec les paramètres par défaut
double TransMercatorMapProjection::GetScaleFactor() const
{ double scaleFactor;
...
///Méthode pour récupérer le FalseNorthing(pour éviter les coordonnées négatives)
 double TransMercatorMapProjection::GetFalseNorthing() const
{
...
double TransMercatorMapProjection::GetFalseEasting() const
{
