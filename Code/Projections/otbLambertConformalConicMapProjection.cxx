...
// Constructeur par défault
  LambertConformalConicMapProjection::LambertConformalConicMapProjection()
{
...
void    LambertConformalConicMapProjection::SetStandardParallel1(double degree) 
{
m_LambertConformalConicProjection->setStandardParallel1(degree);
}

///Spécification du Parallel2
void    LambertConformalConicMapProjection::SetStandardParallel2(double degree) 
{
m_LambertConformalConicProjection->setStandardParallel2(degree);
}

///Spécification des 2 parallels
void    LambertConformalConicMapProjection::SetStandardParallels(double parallel1Degree,double parallel2Degree) 
{
m_LambertConformalConicProjection->setStandardParallels(parallel1Degree,parallel2Degree);
}

///Spécification du false easting
void    LambertConformalConicMapProjection::SetFalseEasting(double falseEasting) 
{
m_LambertConformalConicProjection->setFalseEasting(falseEasting);
}

///Spécification du false Northing
void    LambertConformalConicMapProjection::SetFalseNorthing(double falseNorthing) 
{
m_LambertConformalConicProjection->setFalseNorthing(falseNorthing);
}

///Instanciation de tous les paramètres
void    LambertConformalConicMapProjection::SetParameters(double parallel1Degree,double parallel2Degree,double falseEasting,double falseNorthing) 
{
...
void    LambertConformalConicMapProjection::SetDefaults() 
{
...
///Méthode pour récupérer le FalseNorthing(pour éviter les coordonnées négatives)
 double LambertConformalConicMapProjection::GetFalseNorthing() const
{
...
double LambertConformalConicMapProjection::GetFalseEasting() const
{
