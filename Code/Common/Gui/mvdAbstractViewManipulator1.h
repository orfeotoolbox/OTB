...
#ifndef __mvdAbstractViewManipulator1_h
#define __mvdAbstractViewManipulator1_h
...
/** \class AbstractViewManipulator1
 *
 *  \brief Base class for QWidget manipulation
 */
class Monteverdi2_EXPORT AbstractViewManipulator1 :
    public QObject
{
...
public:
  ...
  /** \brief Constructor. */
  AbstractViewManipulator1( QObject* parent =NULL );

  /** \brief Destructor. */
  virtual ~AbstractViewManipulator1();
...
#endif // __mvdAbstractViewManipulator1_h
