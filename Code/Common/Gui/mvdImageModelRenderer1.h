...
#ifndef __mvdImageModelRenderer1_h
#define __mvdImageModelRenderer1_h
...
public:
  /** Constructor */
  ImageModelRenderer1( QObject* parent = NULL );

  /** Destructor */
  virtual ~ImageModelRenderer1();
...
#endif // __mvdImageModelRenderer1_h
