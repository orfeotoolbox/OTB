...
void
GLImageWidget1
::Initialize( AbstractViewManipulator1* manipulator,
	      AbstractModelRenderer1* renderer )
{
  // Test OpenGL.
  ListGlVersions();
...
::paintGL()
{
  ...
  AbstractModelRenderer1::RenderingContext context(
    m_ImageModel,
