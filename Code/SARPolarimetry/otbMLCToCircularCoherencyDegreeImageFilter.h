...
class  MLCToCircularCoherencyDegreeImageFilter :
...
public:
  ...
  itkTypeMacro(MLCToCircularCoherencyDegreeImageFilter, ImageToImageFilter);
  ...
  /**CircularCoherencyDegree type **/
  typedef itk::Vector<TPixel,3> CircularCoherencyDegreeType;

 
  
  
  /** MLCToCircularCoherencyDegreeImageFilter needs a larger input requested region than
   * the output requested region.  As such, MLCToCircularCoherencyDegreeImageFilter needs
...
protected:
  ...
  /** MLCToCircularCoherencyDegreeImageFilter can be implemented as a multithreaded filter.
...
#include "otbMLCToCircularCoherencyDegreeImageFilter.txx"
#endif
