...
class GLColorImageView 
  : public GLImageView<ImagePixelType, OverlayPixelType> 
  {
  public:
     ...
     *  definition */
    GLColorImageView(int x, int y, int w, int h, const char *l);
...
GLColorImageView(int x, int y, int w, int h, const char *l):
  GLImageView<ImagePixelType, OverlayPixelType>(x, y, w, h, l)
  {
  cClickSelectR = 0;
  cClickSelectG = 0;
  cClickSelectB = 0;
