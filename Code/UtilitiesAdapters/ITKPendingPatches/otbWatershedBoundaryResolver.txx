...
=========================================================================*/
#ifndef __otbWatershedBoundaryResolver_txx
#define __otbWatershedBoundaryResolver_txx
#include "otbWatershedBoundaryResolver.h"
...
::GenerateData()
{
  ...
  // non-flat regions.
  //
  itk::ImageRegionIterator<FaceType> itA(boundaryA->GetFace(idxA),
                                    boundaryA->GetFace(idxA)->GetRequestedRegion());

  itk::ImageRegionIterator<FaceType> itB(boundaryB->GetFace(idxB),
...
template <class TPixelType, unsigned int TDimension>
void BoundaryResolver<TPixelType, TDimension>
::GenerateOutputRequestedRegion(itk::DataObject *)
{
}
...
{
  return static_cast<DataObject*>(itk::EquivalencyTable::New().GetPointer());
}
