...
=========================================================================*/
#ifndef __otbWatershedImageFilter_h
#define __otbWatershedImageFilter_h
...
#include "otbWatershedRelabeler.h"
...
class ITK_EXPORT WatershedImageFilter :
    public itk::ImageToImageFilter< TInputImage, itk::Image<unsigned long,
...
public:
  ...
  typedef itk::Image<unsigned long, itkGetStaticConstMacro(ImageDimension)> OutputImageType;
  ...
  typename itk::watershed::SegmentTreeGenerator<ScalarType>::SegmentTreeType *
  GetSegmentTree()
    {
...
private:
  ...
  typename itk::watershed::SegmentTreeGenerator<ScalarType>::Pointer m_TreeGenerator;
  ...
  itk::TimeStamp m_GenerateDataMTime;
};

} // end namespace otb

#ifndef OTB_MANUAL_INSTANTIATION
#include "otbWatershedImageFilter.txx"
#endif
