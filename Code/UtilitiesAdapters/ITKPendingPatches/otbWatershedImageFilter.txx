...
=========================================================================*/
#ifndef __otbWatershedImageFilter_txx
#define __otbWatershedImageFilter_txx
...
::WatershedImageFilter() :  m_Threshold(0.0), m_Level(0.0)
{
  ...
  m_TreeGenerator= itk::watershed::SegmentTreeGenerator<ScalarType>::New();
  ...
  m_Segmenter->AddObserver(itk::ProgressEvent(), c);
  m_ObserverTag = m_TreeGenerator->AddObserver(itk::ProgressEvent(), c);
  m_Relabeler->AddObserver(itk::ProgressEvent(), c);
