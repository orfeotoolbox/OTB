...
#ifndef __otbInverseDeformationFieldImageFilter_txx
#define __otbInverseDeformationFieldImageFilter_txx
...
::PrepareKernelBaseSpline()
{
  ...
  itk::Point<double, ImageDimension> sourcePoint;
  itk::Point<double, ImageDimension> targetPoint;
