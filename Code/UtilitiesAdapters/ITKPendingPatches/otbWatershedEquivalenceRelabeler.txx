/*=========================================================================
  ...
  Module:    $RCSfile: itkWatershedEquivalenceRelabeler.txx,v $
  Language:  C++
...
=========================================================================*/
#ifndef __otbWatershedEquivalenceRelabeler_txx
#define __otbWatershedEquivalenceRelabeler_txx
#include "otbWatershedEquivalenceRelabeler.h"
...
::GenerateData()
{
  ...
  //
  itk::ImageRegionConstIterator<ImageType> it_a(input, output->GetRequestedRegion());
