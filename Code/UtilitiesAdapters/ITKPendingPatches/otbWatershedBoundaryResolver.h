...
=========================================================================*/
#ifndef __otbWatershedBoundaryResolver_h
#define __otbWatershedBoundaryResolver_h
...
class ITK_EXPORT BoundaryResolver : public itk::ProcessObject
{
public:
  ...
  typedef itk::Boundary<PixelType, TDimension>           BoundaryType;
  typedef itk::EquivalencyTable                          EquivalencyTableType;
  typedef otb::Segmenter<Image<TPixelType, TDimension> > SegmenterType;
  typedef itk::DataObject::Pointer                       DataObjectPointer;
  
  /** Set/Get the first of two boundaries that are to be resolved.   */
  void SetBoundaryA(BoundaryType *bd)
  { this->itk::ProcessObject::SetNthInput(0, bd); }
  ...
  { this->itk::ProcessObject::SetNthInput(1, bd); }
...
#include "otbWatershedBoundaryResolver.txx"
#endif
