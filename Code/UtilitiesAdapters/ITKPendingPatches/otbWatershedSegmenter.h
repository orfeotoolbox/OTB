...
=========================================================================*/
#ifndef __otbWatershedSegmenter_h
#define __otbWatershedSegmenter_h
...
public:
  ...
  typedef itk::Image<unsigned long, itkGetStaticConstMacro(ImageDimension)>
                                                   OutputImageType;
  typedef typename InputImageType::RegionType      ImageRegionType;
  typedef typename InputImageType::PixelType       InputPixelType;
  typedef itk::watershed::Boundary<InputPixelType, itkGetStaticConstMacro(ImageDimension)>
                                                   BoundaryType;
  ...
  typedef itk::watershed::SegmentTable<InputPixelType>             SegmentTableType;
  ...
  { this->itk::ProcessObject::SetNthOutput(1, s); }
  ...
  { this->itk::ProcessObject::SetNthOutput(2,b); }
...
#include "otbWatershedSegmenter.txx"
#endif
