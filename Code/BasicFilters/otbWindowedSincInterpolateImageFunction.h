...
=========================================================================*/
#ifndef _otbWindowedSincInterpolateImageFunction_h
#define _otbWindowedSincInterpolateImageFunction_h
 ...
 * \sa otbWindowedSincInterpolateImageFunction 
 */
 ...
 */
template<class TInputImage, class TWindowFunction = Function::HammingWindowFunction<double, double>, class TBoundaryCondition = itk::ConstantBoundaryCondition<TInputImage>, class TCoordRep=double>
...
public GenericInterpolateImageFunction< TInputImage, 
                                        ...
                                        TCoordRep > 
  {
    ...
    itkTypeMacro(WindowedSincInterpolateImageFunction, GenericInterpolateImageFunction);
    ...
    unsigned int GetSigma(){ return m_Sigma; };
    
    /** Overload method to add the construction of resampledprfil*/
    //void SetRadius(unsigned int rad);
    //unsigned int GetRadius()const{ return Superclass::GetRadius(); };
    ...
    /** Sigma parameter for the gaussian calculation.*/
...
#include "otbWindowedSincInterpolateImageFunction.txx"
#endif
