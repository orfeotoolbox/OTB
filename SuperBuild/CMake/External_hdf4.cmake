...
if(WIN32)
  set(_SB_HDF4_DF_LIB ${SB_INSTALL_PREFIX}/lib/hdf_i.lib)
  set(_SB_HDF4_MFHDF_LIB ${SB_INSTALL_PREFIX}/lib/mfhdf_i.lib)
elseif(UNIX)
  set(_SB_HDF4_DF_LIB ${SB_INSTALL_PREFIX}/lib/libhdf${CMAKE_SHARED_LIBRARY_SUFFIX})
  set(_SB_HDF4_MFHDF_LIB ${SB_INSTALL_PREFIX}/lib/libmfhdf${CMAKE_SHARED_LIBRARY_SUFFIX})
endif()
