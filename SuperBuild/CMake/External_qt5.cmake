...
if(WIN32)
  set(QT5_BIN_EXT ".exe")
  set(QT5_CONFIGURE_COMMAND ${CMAKE_BINARY_DIR}/QT5/src/QT5-stamp/configure_qt5.bat)
  ...
  set(QT5_BUILD_COMMAND ${CMAKE_BINARY_DIR}/QT5/src/QT5-stamp/build_qt5.bat)
  configure_file( ${QT5_BUILD_COMMAND_IN} ${QT5_BUILD_COMMAND} @ONLY )
else()
  set(QT5_BIN_EXT "")
  file(TO_NATIVE_PATH ${QT5_SB_SRC}/configure QT5_CONFIGURE_SCRIPT)
  set(QT5_CONFIGURE_COMMAND ${CMAKE_BINARY_DIR}/QT5/src/QT5-stamp/configure_qt5.sh)
