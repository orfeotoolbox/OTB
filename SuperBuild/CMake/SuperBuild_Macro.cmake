...
macro(SETUP_SUPERBUILD)
  ...
  set_property(GLOBAL PROPERTY ${project}_DEPENDENCIES "")
...
macro(ADDTO_DEPENDENCIES_IF_NOT_SYSTEM project)
  set(PROJ_NAME_BACKUP ${project})
  foreach(dep ${ARGN})
    if(NOT USE_SYSTEM_${dep})
      get_property(prop_${project}_DEPENDENCIES GLOBAL PROPERTY ${project}_DEPENDENCIES)
      list(APPEND prop_${project}_DEPENDENCIES "${dep}")
      set_property(GLOBAL PROPERTY ${project}_DEPENDENCIES "${prop_${project}_DEPENDENCIES}")
    endif()
