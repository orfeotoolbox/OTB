...
macro(otb_module _name)
  ...
  set(OTB_MODULE_${otb-module}_EXPORT_ALL 0)
  foreach(arg ${ARGN})
    ...
    elseif("${arg}" MATCHES "^EXPORT_ALL$")
      set(_doing "")
      set(OTB_MODULE_${otb-module}_EXPORT_ALL 1)
...
macro(otb_module_impl)
  ...
  if( OTB_MODULE_${otb-module}_ENABLE_SHARED )
    ...
    if (BUILD_SHARED_LIBS)
      ...
      if (USE_COMPILER_HIDDEN_VISIBILITY AND NOT OTB_MODULE_${otb-module}_EXPORT_ALL)
