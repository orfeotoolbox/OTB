...
if(NOT OTB_MODULES_ENABLED)
  ...
  file(REMOVE "${OTB_BINARY_DIR}/OTBCoreTargets.cmake")
  return()
endif()

file(WRITE "${OTB_BINARY_DIR}/OTBCoreTargets.cmake"
...
macro(init_module_vars)
  ...
  set(${otb-module}-targets OTB${OTB_MODULE_${otb-module}_COMPONENT}Targets)
  set(${otb-module}-targets-install "${OTB_INSTALL_PACKAGE_DIR}/${OTB_MODULE_${otb-module}_COMPONENT}Targets.cmake")
  set(${otb-module}-targets-build "${OTB_BINARY_DIR}/${OTB_MODULE_${otb-module}_COMPONENT}Targets.cmake")
endmacro()
