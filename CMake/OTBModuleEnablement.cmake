...
# NOTE TLA: if we get one target file per module, is this still relevent?
# file(WRITE "${OTB_BINARY_DIR}/CoreTargets.cmake"
...
macro(init_module_vars)
  ...
  # message(STATUS "\${otb-module}-targets of ${otb-module} == ${${otb-module}-targets}")
  # message(STATUS "\${otb-module}-targets-install of ${otb-module} == ${${otb-module}-targets-install}")
  # message(STATUS "\${otb-module}-targets-build of ${otb-module} == ${${otb-module}-targets-build}")
endmacro()
