...
#   OPTION(FFTWD_LIB "The full path to the fftw3 library (including the library)" )
    ...
    FIND_PACKAGE_HANDLE_STANDARD_ARGS(FFTWD DEFAULT_MSG FFTWD_LIB FFTW_INCLUDE_PATH)
...
#   OPTION(FFTWF_LIB "The full path to the fftw3f library (including the library)" )
    ...
    # all listed variables are TRUE
    INCLUDE(FindPackageHandleStandardArgs)
    FIND_PACKAGE_HANDLE_STANDARD_ARGS(FFTWF DEFAULT_MSG FFTWF_LIB FFTW_INCLUDE_PATH)
