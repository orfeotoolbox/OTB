...
foreach( group ${group_list})
    if(NOT DEFINED OTBGroup_${group})
      set(_request_build OFF)
      if(DEFINED(OTB_BUILD_${group}))
        set(_request_build ${OTB_BUILD_${group}})
      endif()
      #Option does not change the cache so we have to use set CACHE instead of option
      set(OTBGroup_${group} ${_request_build} CACHE BOOL "Request building ${group} modules" FORCE)
    endif()
    if (OTBGroup_${group})
