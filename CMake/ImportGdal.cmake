...
IF(OTB_USE_EXTERNAL_GDAL)
  ...
  # Find tiff headers
  FIND_PATH(TIFF_INCLUDE_DIRS tiffio.h ${GDAL_INCLUDE_DIR} /usr/include)
  ...
  # Find jpeg headers
  FIND_PATH(JPEG_INCLUDE_DIRS jpeglib.h ${GDAL_INCLUDE_DIR} /usr/include)
  ...
  # Find ogr headers
  FIND_PATH(OGR_INCLUDE_DIRS ogrsf_frmts.h ${GDAL_INCLUDE_DIR} /usr/include)
