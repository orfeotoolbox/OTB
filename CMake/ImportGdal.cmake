...
IF(OTB_USE_EXTERNAL_GDAL)
  ...
  FIND_PATH(GEOTIFF_INCLUDE_DIRS geotiff.h ${GDAL_INCLUDE_DIR} ${OSGEO4W_INCLUDE} /usr/include/geotiff /usr/include/libgeotiff)
  ...
  # Find tiff headers
  FIND_PATH(TIFF_INCLUDE_DIRS tiffio.h ${GDAL_INCLUDE_DIR} ${OSGEO4W_INCLUDE} /usr/include)
  ...
  # Find jpeg headers
  FIND_PATH(JPEG_INCLUDE_DIRS jpeglib.h ${GDAL_INCLUDE_DIR} ${OSGEO4W_INCLUDE} /usr/include)
  ...
  # Find ogr headers
  FIND_PATH(OGR_INCLUDE_DIRS ogrsf_frmts.h ${GDAL_INCLUDE_DIR} ${OSGEO4W_INCLUDE} /usr/include)
