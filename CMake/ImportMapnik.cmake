...
IF(OTB_USE_MAPNIK)
        ...
        TRY_COMPILE(MAPNIK_SUPPORTS_NEW_INTERFACE
          ...
          CMAKE_FLAGS "-DINCLUDE_DIRECTORIES:PATH=${MAPNIK_INCLUDE_DIR};${ICUUC_INCLUDE_DIR};${LTDL_INCLUDE_DIR};${FREETYPE2_INCLUDE_DIR}" "-DLINK_LIBRARIES:STRING=${MAPNIK_LIBRARY}"
