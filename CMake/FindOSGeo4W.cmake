...
IF(WIN32)
    FIND_PATH(OSGEO4W_ROOT NAMES OSGeo4W.bat PATHS ENV{OSGEO4W_ROOT} C:/OSGeo4W )
	IF(OSGEO4W_ROOT)
		...
		IF(NOT TIFF_INCLUDE_DIR OR NOT TIFF_LIBRARY)
		  MESSAGE(WARNING "OSGeo4W found but TIFF is not found : Please install the 'libtiff' package from the OSGeo4W Setup")
		ENDIF()
		...
		IF(NOT LIBLAS_INCLUDE_DIR OR NOT LIBLAS_LIBRARY)
		  MESSAGE(WARNING "OSGeo4W found but LibLAS is not found : Please install the 'liblas' package from the OSGeo4W Setup")
		ENDIF()
